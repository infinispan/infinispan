...
public class FlightRoute {
   ...
   public final Double endLon;
    ...
    public static Map<String, FlightRoute> data() {
       Map<String, FlightRoute> data = new HashMap<>();
       data.put("flightA", new FlightRoute("A", 46.7716, 23.5895, 37.7608, 140.4748));
       data.put("flightB", new FlightRoute("B", 43.7716, 20.5895, 34.7608, 137.4748));
       return data;
    }
