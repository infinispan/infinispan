...
public class Account implements Serializable {
   public static final String ENTITY_NAME = "sample_domain.Account";

   public enum Currency {
      @ProtoEnumValue(0) EUR, @ProtoEnumValue(1) GBP, @ProtoEnumValue(2) USD, @ProtoEnumValue(3) BRL
   }
   ...
   public static class Limits implements Serializable {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(maxDailyLimit, limits.maxDailyLimit) && Objects.equals(maxTransactionLimit, limits.maxTransactionLimit) && Arrays.equals(payees, limits.payees);
      }
      ...
      public String toString() {
         return "Limits{" + "maxDailyLimit=" + maxDailyLimit + ", maxTransactionLimit=" + maxTransactionLimit + ", payees=" + Arrays.toString(payees) + '}';
      }
   }
   ...
   public boolean equals(Object o) {
      ...
      return id == account.id && Objects.equals(description, account.description) && Objects.equals(creationDate, account.creationDate) && Objects.equals(limits, account.limits) && Objects.equals(hardLimits, account.hardLimits) && Objects.equals(blurb, account.blurb) && Objects.deepEquals(currencies, account.currencies);
   }

   @Override
   public int hashCode() {
      return Objects.hash(id, description, creationDate, limits, hardLimits, blurb, Arrays.hashCode(currencies));
   }

   @Override
   public String toString() {
      return "Account{" + "id=" + id + ", description='" + description + '\'' + ", creationDate=" + creationDate + ", limits=" + limits + ", hardLimits=" + hardLimits + ", blurb=" + blurb + ", currencies=" + Arrays.toString(currencies) + '}';
   }
