...
public abstract class AbstractMatcherTest {
   ...
   public void testFilterInterference() throws Exception {
      ...
      int[] matchCount = {0, 0};
      String queryString1 = "from org.infinispan.query.objectfilter.test.model.Person p where p.name = 'John'";
      matcher.registerFilter(queryString1, (userContext, eventType, instance, projection, sortProjection) -> matchCount[0]++);

      String queryString2 = "from org.infinispan.query.objectfilter.test.model.Person p where p.phoneNumbers.number = '004012345'";
   ...
   public void testOrderBy() throws Exception {
      ...
      String queryString1 = "from org.infinispan.query.objectfilter.test.model.Person p where p.age > 18 order by p.name, p.surname";
