...
public class PerfTest {
   ...
   public void testLikeMatchPerf() throws Exception {
      long time = measureMatch("from org.infinispan.query.objectfilter.test.model.Person p where p.name like 'Jo%'");
      printTime("testLikeMatchPerf", time);
   }

   @Test
   public void testIsNullMatchPerf() throws Exception {
      long time = measureMatch("from org.infinispan.query.objectfilter.test.model.Person p where p.name is not null");
      printTime("testIsNullMatchPerf", time);
   }

   @Test
   public void testComplexMatchPerf() throws Exception {
      long time = measureMatch("from org.infinispan.query.objectfilter.test.model.Person p where p.surname = 'Batman' and p.age > 30 and p.name > 'A' and p.address.postCode = 'SW12345'");
   ...
   public void testSimpleObjectFilterPerf() throws Exception {
      long time = measureFilter("from org.infinispan.query.objectfilter.test.model.Person p where p.name is not null");
      printTime("testSimpleObjectFilterPerf", time);
   }

   @Test
   public void testComplexObjectFilterPerf() throws Exception {
      long time = measureFilter("from org.infinispan.query.objectfilter.test.model.Person p where p.surname = 'Batman' and p.age > 30 and p.name > 'A' and p.address.postCode = 'SW12345'");
