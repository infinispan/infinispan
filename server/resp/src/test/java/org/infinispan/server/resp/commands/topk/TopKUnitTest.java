...
public class TopKUnitTest {
   ...
   public void testListWithoutCount() {
      ...
      // Sorted by count descending, items are byte[]
      assertThat(list.get(0)).isEqualTo(bytes("a"));
      assertThat(list.get(1)).isEqualTo(bytes("b"));
      assertThat(list.get(2)).isEqualTo(bytes("c"));
   }
   ...
   public void testListWithCount() {
      ...
      assertThat(list.get(2)).isEqualTo(bytes("b"));
      assertThat(list.get(3)).isEqualTo(5L);
      assertThat(list.get(4)).isEqualTo(bytes("c"));
   ...
   public void testProtoStreamRoundTrip() {
      ...
      long[] flatFp = topK.getFlatFingerprints();
