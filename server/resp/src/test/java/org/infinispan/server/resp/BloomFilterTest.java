...
public class BloomFilterTest extends SingleNodeRespBaseTest {
   ...
   public void testBfAdd() {
      ...
      // Add the same item again - should return false
   ...
   public void testBfMadd() {
      ...
      // Add same items again - all should return false
   ...
   public void testBfInsert() {
      ...
      // Insert again - existing items should return false
      results = redis.dispatch(
            command("BF.INSERT"),
            new BooleanListOutput<>(StringCodec.UTF8),
