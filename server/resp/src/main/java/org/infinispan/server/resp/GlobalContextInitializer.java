...
@ProtoSchema(
      ...
      includeClasses = {
            ...
            org.infinispan.server.resp.json.JsonLenFunction.class,
            org.infinispan.server.resp.json.JsonNumIncrByFunction.class,
            ...
            org.infinispan.server.resp.json.LenType.class,
      },
