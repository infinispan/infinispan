 ...
 * @since 7.0
 */
public class SaslPropertyAdd extends AbstractAddStepHandler {
   static final SaslPropertyAdd INSTANCE = new SaslPropertyAdd(SaslPropertyResource.SASL_PROPERTY_ATTRIBUTES);

   private final AttributeDefinition[] attributes;

   SaslPropertyAdd(final AttributeDefinition[] attributes) {
