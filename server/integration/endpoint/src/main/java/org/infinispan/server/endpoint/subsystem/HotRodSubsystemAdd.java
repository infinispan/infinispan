...
class HotRodSubsystemAdd extends ProtocolServiceSubsystemAdd {
   ...
   protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
      ...
      EndpointUtils.addSocketBindingDependency(context, builder, getSocketBindingName(operation), service.getSocketBinding(), ServiceBuilder.DependencyType.OPTIONAL);
