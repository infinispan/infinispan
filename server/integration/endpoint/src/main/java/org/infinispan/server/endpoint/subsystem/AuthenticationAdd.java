 ...
 * @since 7.0
 */
public class AuthenticationAdd extends AbstractAddStepHandler {
   static final AuthenticationAdd INSTANCE = new AuthenticationAdd(AuthenticationResource.AUTHENTICATION_ATTRIBUTES);

   private final AttributeDefinition[] attributes;

   AuthenticationAdd(final AttributeDefinition[] attributes) {
