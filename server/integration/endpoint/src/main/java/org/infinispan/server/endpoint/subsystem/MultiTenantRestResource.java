...
public class MultiTenantRestResource extends SimpleResourceDefinition {
    ...
    public MultiTenantRestResource() {
        super(REST_PATH, EndpointExtension.getResourceDescriptionResolver(ModelKeys.REST), MultiTenantRestSubsystemAdd.INSTANCE, ReloadRequiredRemoveStepHandler.INSTANCE);
    }
