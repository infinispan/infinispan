...
public class ServerEventImpl implements EventLog {
   ...
   ServerEventImpl(EventLogLevel level, Instant when, String message, Optional<String> detail, Optional<String> context, Optional<String> who, Optional<String> scope) {
      this.level = level;
   ...
   ServerEventImpl(EventLogLevel level, Instant when, String message) {
      this(level, when, message, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
   }
   ...
   public static class Externalizer extends AbstractExternalizer<ServerEventImpl> {
      ...
      public ServerEventImpl readObject(ObjectInput oi) throws IOException, ClassNotFoundException {
         ...
         return new ServerEventImpl(level, when, message, detail, context, who, scope);
      }
