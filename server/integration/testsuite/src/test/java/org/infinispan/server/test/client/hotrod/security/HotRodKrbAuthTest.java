...
public class HotRodKrbAuthTest extends HotRodSaslAuthTestBase {
   ...
   protected Subject getSubject(String login, String password) throws LoginException {
      System.setProperty("java.security.auth.login.config", HotRodKrbAuthTest.class.getResource("/jaas_krb_login.conf")
            .getPath());
      System.setProperty("java.security.krb5.conf", HotRodKrbAuthTest.class.getResource("/krb5.conf").getPath());
