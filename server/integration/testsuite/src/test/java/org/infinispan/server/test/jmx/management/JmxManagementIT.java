...
public class JmxManagementIT {
    ...
    public void testCacheManagerAttributes() throws Exception {
        assertEquals(7, Integer.parseInt(getAttribute(provider, cacheManagerMBean, "CreatedCacheCount")));
        assertEquals(7, Integer.parseInt(getAttribute(provider, cacheManagerMBean, "DefinedCacheCount")));
        ...
        assertEquals(7, Integer.parseInt(getAttribute(provider, cacheManagerMBean, "RunningCacheCount")));
