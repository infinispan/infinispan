...
public class SubsystemParsingTestCase extends ClusteringSubsystemTest {
    ...
    public static Collection<Object[]> data() {
      Object[][] data = new Object[][] {
                                         { Namespace.INFINISPAN_SERVER_6_0, 109, "schema/jboss-infinispan-core_6_0.xsd" },
                                         { Namespace.INFINISPAN_SERVER_7_0, 132, "schema/jboss-infinispan-core_7_0.xsd" },
                                         { Namespace.INFINISPAN_SERVER_7_1, 132, "schema/jboss-infinispan-core_7_1.xsd" },
                                         { Namespace.INFINISPAN_SERVER_7_2, 132, "schema/jboss-infinispan-core_7_2.xsd" },
                                         { Namespace.INFINISPAN_SERVER_8_0, 144, "schema/jboss-infinispan-core_8_0.xsd" },
                                         { Namespace.INFINISPAN_SERVER_8_1, 145, "schema/jboss-infinispan-core_8_1.xsd" },
                                         { Namespace.INFINISPAN_SERVER_8_2, 145, "schema/jboss-infinispan-core_8_2.xsd" },
                                         { Namespace.INFINISPAN_SERVER_9_0, 145, "schema/jboss-infinispan-core_9_0.xsd"},
      };
