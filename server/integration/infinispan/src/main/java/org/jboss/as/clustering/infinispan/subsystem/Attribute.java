...
public enum Attribute {
    ...
    COMPACTION_THRESHOLD(ModelKeys.COMPACTION_THRESHOLD),
    ...
    OPEN_FILES_LIMIT(ModelKeys.OPEN_FILES_LIMIT),
    ...
    SYNC_WRITES(ModelKeys.SYNC_WRITES),
