...
public class CacheAuthorizationConfigurationResource extends CacheConfigurationChildResource {
    ...
    private static final PathElement PATH = PathElement.pathElement(ModelKeys.AUTHORIZATION);
    ...
    CacheAuthorizationConfigurationResource(RestartableResourceDefinition parent) {
        super(PATH, String.format("%s.%s.%s", ModelKeys.CACHE, ModelKeys.SECURITY, ModelKeys.AUTHORIZATION), parent, ATTRIBUTES);
    }
