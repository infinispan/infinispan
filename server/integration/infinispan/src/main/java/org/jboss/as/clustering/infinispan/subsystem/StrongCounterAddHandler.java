...
public class StrongCounterAddHandler extends CounterAddHandler {
   ...
   void processModelNode(OperationContext context, String containerName, ModelNode counter, CounterConfigurationBuilder builder, List<Dependency<?>> dependencies)
      ...
      StrongCounterConfigurationBuilder sBuilder = (StrongCounterConfigurationBuilder) builder;
      ...
      sBuilder.lowerBound(lowerBound);
      sBuilder.upperBound(upperBound);           
   }
}
