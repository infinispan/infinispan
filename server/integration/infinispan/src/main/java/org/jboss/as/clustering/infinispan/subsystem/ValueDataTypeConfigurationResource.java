 ...
 * @since 9.2
 */
public class ValueDataTypeConfigurationResource extends CacheConfigurationChildResource {

   public static final PathElement PATH = PathElement.pathElement(ModelKeys.ENCODING, ModelKeys.VALUE);
   ...
   public ValueDataTypeConfigurationResource(CacheConfigurationResource parent) {
