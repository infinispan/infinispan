...
public enum Namespace {
    ...
    INFINISPAN_SERVER_9_3("infinispan:server:core", 9, 3),
    INFINISPAN_SERVER_9_4("infinispan:server:core", 9, 4);
    private static final String URN_PATTERN = "urn:%s:%d.%d";

    /**
     * The current namespace version.
     */
    public static final Namespace CURRENT = INFINISPAN_SERVER_9_4;
