 ...
 */
public class ExpirationResource extends CacheChildResource {
    ...
    public ExpirationResource(CacheResource cacheResource) {
        super(EXPIRATION_PATH, ModelKeys.EXPIRATION, cacheResource, EXPIRATION_ATTRIBUTES);
    }
}
