...
import org.infinispan.server.functional.LegacyMetricsXSiteIT;
...
public class LegacyXSiteRestMetricsOperations {
   ...
   @RegisterExtension
   public static final InfinispanXSiteServerExtension SERVERS = LegacyMetricsXSiteIT.SERVERS;
