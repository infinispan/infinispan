...
import static org.infinispan.server.test.core.ContainerInfinispanServerDriver.STARTUP_MESSAGE_REGEX;
import static org.infinispan.server.test.core.ForkedServer.TIMEOUT_SECONDS;
...
public class RestReindexAutoCacheIT {
   ...
   private void restartReusingContainer() {
      InfinispanGenericContainer container = ((ContainerInfinispanServerDriver) SERVER.getServerDriver()).getContainer(0);
   ...
   public static <K, V> RemoteCache<K, V> createQueryablePersistentCache(RemoteCacheManager remoteCacheManager, Schema protoschema, String entityName) {
      ...
      SoftIndexFileStoreConfigurationBuilder softIndexBuilder = builder
            .persistence()
            .addSoftIndexFileStore().dataLocation("data")
            .indexLocation("index");
