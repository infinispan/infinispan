 ...
 * <p>
 * X-Site operations are divided into two levels:
...
public class XSiteResourceV3 extends XSiteResource {
   ...
   public Invocations getInvocations() {
      ...
      // ===== CACHE-LEVEL X-SITE OPERATIONS =====

      // 1. Clear Push State Status
      builder.invocation()
            .methods(POST).path("/v3/caches/{cacheName}/x-site/local-push-state/_clear")
            .name("Clear push state status for cache")
            .operationId("clearCachePushStateStatusV3")
      ...
      builder.invocation()
            ...
            .operationId("listCacheBackupSitesV3")
            .response(OK, "List of backup site statuses", APPLICATION_JSON)
            .response(NOT_FOUND, "Cache not found or x-site not configured", TEXT_PLAIN, Schema.STRING)
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.CACHE)
      ...
      builder.invocation()
            .methods(GET).path("/v3/caches/{cacheName}/x-site/backups-push-state/_status")
            .name("Get push state status for cache")
            .operationId("getCachePushStateStatusV3")
      ...
      builder.invocation()
            ...
            .operationId("getCacheBackupSiteStatusV3")
      ...
      builder.invocation()
            ...
            .operationId("takeCacheSiteOfflineV3")
      ...
      builder.invocation()
            ...
            .operationId("bringCacheSiteOnlineV3")
      ...
      builder.invocation()
            ...
            .operationId("startCachePushStateV3")
      ...
      builder.invocation()
            ...
            .operationId("cancelCachePushStateV3")
      ...
      builder.invocation()
            ...
            .operationId("cancelCacheReceiveStateV3")
      ...
      builder.invocation()
            ...
            .operationId("getCacheTakeOfflineConfigV3")
      ...
      builder.invocation()
            ...
            .operationId("updateCacheTakeOfflineConfigV3")
      ...
      builder.invocation()
            ...
            .operationId("getCacheStateTransferModeV3")
      ...
      builder.invocation()
            ...
            .operationId("setCacheStateTransferModeV3")
      ...
      builder.invocation()
            ...
            .operationId("getGlobalSiteStatusV3")
            .response(OK, "Global site status", APPLICATION_JSON)
            .response(NOT_FOUND, "Site not found or x-site not configured", TEXT_PLAIN, Schema.STRING)
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.CACHEMANAGER)
            .handleWith(this::globalStatus);
      ...
      builder.invocation()
            ...
            .operationId("bringAllCachesOnlineV3")
      ...
      builder.invocation()
            ...
            .operationId("takeAllCachesOfflineV3")
      ...
      builder.invocation()
            ...
            .operationId("startPushAllCachesV3")
      ...
      builder.invocation()
            ...
            .operationId("cancelPushAllCachesV3")
