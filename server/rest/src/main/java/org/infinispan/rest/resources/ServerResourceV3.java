...
public class ServerResourceV3 extends ServerResource {
   ...
   public Invocations getInvocations() {
      ...
      builder.invocation()
            ...
            .operationId("getOverviewReportV3")
            .permission(AuthorizationPermission.ADMIN)
      ...
      builder.invocation()
            ...
            .operationId("listIgnoredCachesV3")
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.SERVER)
      ...
      builder.invocation()
            ...
            .operationId("getConnectorStatusV3")
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.SERVER)
      ...
      builder.invocation()
            ...
            .operationId("getConnectorIpFilterV3")
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.SERVER)
      ...
      builder.invocation()
            ...
            .operationId("setConnectorIpFilterV3")
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.SERVER)
      ...
      builder.invocation()
            ...
            .operationId("clearConnectorIpFilterV3")
            .permission(AuthorizationPermission.ADMIN)
            .auditContext(AuditContext.SERVER)
      ...
      builder.invocation()
            ...
            .operationId("getCacheDefaultsV3")
