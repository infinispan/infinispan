...
public class Http20RequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
   ...
   public void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
      ...
      sendResonse(ctx, request, response.toNettyHttpResponse());
   }

   protected void sendResonse(ChannelHandlerContext ctx, FullHttpRequest request, FullHttpResponse response) {
