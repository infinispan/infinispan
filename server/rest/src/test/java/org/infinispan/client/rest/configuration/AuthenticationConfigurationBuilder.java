...
public class AuthenticationConfigurationBuilder extends AbstractSecurityConfigurationChildBuilder implements Builder<AuthenticationConfiguration> {
   ...
   public AuthenticationConfiguration create() {
      ...
      return new AuthenticationConfiguration(clientSubject, enabled, mech);
   }
   ...
   public ConfigurationBuilder withProperties(Properties properties) {
      ...
      if (typed.containsKey(ConfigurationProperties.AUTH_MECHANISM))
        mechanism(typed.getProperty(ConfigurationProperties.AUTH_MECHANISM, mechanism, true));
