...
public class XSiteResourceV3Test extends AbstractRestResourceTest {
   ...
   public void testOpenAPIIncludesXSiteV3() {
      ...
      assertTrue(paths.has("/rest/v3/caches/{cacheName}/x-site/backups-push-state/_status"));
      ...
      assertTrue(paths.has("/rest/v3/caches/{cacheName}/x-site/local-push-state/_clear"));
