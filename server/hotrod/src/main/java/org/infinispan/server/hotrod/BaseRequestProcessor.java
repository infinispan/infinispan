...
/**
 * This class is not thread safe. The expected use is to set {@link #cdc}, call some method in inheriting classes
 * and then reset the cdc. Therefore each handler should have its own instance(s).
 */
