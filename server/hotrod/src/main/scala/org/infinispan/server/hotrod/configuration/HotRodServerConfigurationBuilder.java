...
public class HotRodServerConfigurationBuilder extends ProtocolServerConfigurationBuilder<HotRodServerConfiguration, HotRodServerConfigurationBuilder> implements
   ...
   /**
    * Named key/value filter factory, configured to filter remote events server side.
    * Filtering can reduce the amount of traffic generated by remote events by
    * only sending those that are relevant to the clients. By default, no
   ...
   /**
    * Converter factory, configured to customize the standard remote event
    * payloads to add more information to events, or remove information which
    * is not neeed by clients. By default, no converters are configured.
    */
   ...
   public HotRodServerConfiguration create() {
      return new HotRodServerConfiguration(defaultCacheName, proxyHost, proxyPort, topologyLockTimeout, topologyReplTimeout, topologyAwaitInitialTransfer, topologyStateTransfer, name, host, port, idleTimeout,
            ...
            keyValueFilterFactories, converterFactories, marshallerClass);
   }
