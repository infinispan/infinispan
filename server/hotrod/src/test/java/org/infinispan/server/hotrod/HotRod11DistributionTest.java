...
public class HotRod11DistributionTest extends HotRodMultiNodeTest {
   ...
   public void testDistributedPutWithTopologyChanges(Method m) {
      ...
      assertHashTopologyReceived(resp.topologyResponse, servers(), cacheName(), 2, virtualNodes(),
                                 currentServerTopologyId());
      ...
      try {
         ...
         assertStatus(resp, Success);
         assertHashTopologyReceived(resp.topologyResponse, allServers, cacheName(), 2, virtualNodes(),
                                    currentServerTopologyId());
