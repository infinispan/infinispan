...
public class HotRod11StorageOnlyNodesTest extends HotRodMultiNodeTest {
   ...
   public void testAddingStorageOnlyNode(Method m) throws Exception {
      ...
      try {
         ...
         TestingUtil.waitForStableTopology(cache(0, cacheName()), cache(1, cacheName()), cache(2, cacheName()));
         ...
         TestingUtil.waitForStableTopology(cache(0, cacheName()), cache(2, cacheName()));
         ...
         TestingUtil.waitForStableTopology(cache(0, cacheName()));
      }
