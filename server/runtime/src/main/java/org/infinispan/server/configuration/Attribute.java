...
public enum Attribute {
   ...
   WRAP_GSS_CREDENTIAL,
   WRITABLE,
   STATISTICS, DRIVER, USERNAME(), PASSWORD(), TRANSACTION_ISOLATION(), NEW_CONNECTION_SQL(), MAX_SIZE(), MIN_SIZE(), INITIAL_SIZE(), BLOCKING_TIMEOUT(), BACKGROUND_VALIDATION(), LEAK_DETECTION(), IDLE_REMOVAL(), METRICS_AUTH;
