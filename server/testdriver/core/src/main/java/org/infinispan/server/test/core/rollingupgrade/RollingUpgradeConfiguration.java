...
public record RollingUpgradeConfiguration(int nodeCount, String fromVersion, String toVersion, String jgroupsProtocol,
                                          int serverCheckTimeSecs, boolean useSharedDataMount,
