...
public class RollingUpgradeHandlerExtension extends AbstractServerExtension implements BeforeEachCallback,
   ...
   public static RollingUpgradeHandlerExtension from(InfinispanServerExtensionBuilder iseb, String fromVersion, String toVersion) {
      return new RollingUpgradeHandlerExtension(convertBuilder(iseb, fromVersion, toVersion));
   }

   public static RollingUpgradeConfigurationBuilder convertBuilder(InfinispanServerExtensionBuilder iseb,
