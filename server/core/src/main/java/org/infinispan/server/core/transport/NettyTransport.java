...
public class NettyTransport implements Transport {
   ...
   private boolean shouldShutdownIOGroup;
   ...
   public static MultithreadEventLoopGroup buildEventLoop(int nThreads, DefaultThreadFactory threadFactory) {
