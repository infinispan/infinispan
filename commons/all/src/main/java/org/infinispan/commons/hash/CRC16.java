 ...
 *
 * @see <a href="https://github.com/lettuce-io/lettuce-core/blob/2ad862f5a1db860d57236c21c473cfd9aefebfea/src/main/java/io/lettuce/core/codec/CRC16.java">Lettuce Implementation.</a>
 * @see <a href="https://introcs.cs.princeton.edu/java/61data/CRC16.java">Princeton implementation.</a>
 * @since 15.0
 */
@ThreadSafe
@Immutable
...
public class CRC16 implements Hash {
   ...
   public int hash(int hashcode) {
      ...
      return hash(new byte[] { b0, b1, b2, b3 });
   }
   ...
   private static class CRC16Table {
      ...
      // See: https://github.com/lettuce-io/lettuce-core/blob/2ad862f5a1db860d57236c21c473cfd9aefebfea/src/main/java/io/lettuce/core/codec/CRC16.java#L35
