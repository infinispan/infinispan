...
public interface BasicConfiguration {
    ...
    */
   default String toStringConfiguration(String name, MediaType mediaType, boolean clearTextSecrets, ConfigurationSchemaVersion target) {
      return toStringConfiguration(name, mediaType, clearTextSecrets);
   }
}
