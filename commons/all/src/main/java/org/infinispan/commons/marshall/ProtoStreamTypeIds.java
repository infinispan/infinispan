...
//   int BITSET = CORE_LOWER_BOUND + 13;
   ...
   // Conflict resolution
   int SEGMENT_HASH = CORE_LOWER_BOUND + 337;
   int BUCKET_HASH = CORE_LOWER_BOUND + 338;
   int GET_BUCKET_HASHES_COMMAND = CORE_LOWER_BOUND + 339;
   int GET_BUCKET_ENTRIES_COMMAND = CORE_LOWER_BOUND + 340;

   int REMOVE_ALL_COMMAND = CORE_LOWER_BOUND + 341;
   int REMOVE_ALL_BACKUP_WRITE_COMMAND = CORE_LOWER_BOUND + 342;
...
// int KNOWN_CLASS_KEY = QUERY_LOWER_BOUND;
   ...
   int ICKLE_UPDATE_BI_FUNCTION = QUERY_LOWER_BOUND + 24;
