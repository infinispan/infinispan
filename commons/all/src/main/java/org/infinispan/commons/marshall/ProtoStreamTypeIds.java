...
public interface ProtoStreamTypeIds {
   ...
   int RESP_JSON_ARRAY_APPEND_FUNCTION = RESP_LOWER_BOUND + 11;
   int RESP_JSON_ARRINDEX_FUNCTION = RESP_LOWER_BOUND + 12;
   int RESP_JSON_DEL_FUNCTION = RESP_LOWER_BOUND + 13;
   int RESP_JSON_GET_FUNCTION = RESP_LOWER_BOUND + 14;
   int RESP_JSON_LEN_FUNCTION = RESP_LOWER_BOUND + 15;
   int RESP_JSON_NUM_INCR_BY_FUNCTION = RESP_LOWER_BOUND + 16;
   int RESP_JSON_OBJ_KEY_FUNCTION = RESP_LOWER_BOUND + 17;
   int RESP_JSON_SET_FUNCTION = RESP_LOWER_BOUND + 18;
   int RESP_JSON_STRING_APPEND_FUNCTION = RESP_LOWER_BOUND + 19;
   int RESP_JSON_TOGGLE_FUNCTION = RESP_LOWER_BOUND + 20;
   int RESP_JSON_TYPE_FUNCTION = RESP_LOWER_BOUND + 21;
   int RESP_JSON_LEN_TYPE = RESP_LOWER_BOUND + 22;
   int RESP_JSON_ARRINSERT_FUNCTION = RESP_LOWER_BOUND + 23;
   int RESP_JSON_ARRPOP_FUNCTION = RESP_LOWER_BOUND + 24;
   int RESP_JSON_ARRTRIM_FUNCTION = RESP_LOWER_BOUND + 25;
   int RESP_JSON_CLEAR_FUNCTION = RESP_LOWER_BOUND + 26;
   int RESP_TYPES = RESP_LOWER_BOUND + 27;
