...
//   int BITSET = CORE_LOWER_BOUND + 13;
   ...
   // Rendezvous CH factories
   int RENDEZVOUS_CONSISTENT_HASH_FACTORY = CORE_LOWER_BOUND + 342;
   int TOPOLOGY_AWARE_RENDEZVOUS_CONSISTENT_HASH_FACTORY = CORE_LOWER_BOUND + 343;
   int PURE_RENDEZVOUS_CONSISTENT_HASH_FACTORY = CORE_LOWER_BOUND + 344;
   int PURE_TOPOLOGY_AWARE_RENDEZVOUS_CONSISTENT_HASH_FACTORY = CORE_LOWER_BOUND + 345;
   int HISTORY_HINTED_RENDEZVOUS_CONSISTENT_HASH_FACTORY = CORE_LOWER_BOUND + 346;
...
//   int FILE_LIST_CACHE_VALUE = LUCENE_LOWER_BOUND + 5;
   ...
   int RESP_BITFIELD_OPERATION_TYPE = RESP_LOWER_BOUND + 60;
   int RESP_BITFIELD_OVERFLOW = RESP_LOWER_BOUND + 61;
   int RESP_TOP_K = RESP_LOWER_BOUND + 62;
   int RESP_TOP_K_ENTRY = RESP_LOWER_BOUND + 63;
   int RESP_TOPK_RESERVE_FUNCTION = RESP_LOWER_BOUND + 64;
   int RESP_TOPK_ADD_FUNCTION = RESP_LOWER_BOUND + 65;
   int RESP_TOPK_INCRBY_FUNCTION = RESP_LOWER_BOUND + 66;
   int RESP_TOPK_QUERY_FUNCTION = RESP_LOWER_BOUND + 67;
   int RESP_TOPK_LIST_FUNCTION = RESP_LOWER_BOUND + 68;
   int RESP_TOPK_INFO_FUNCTION = RESP_LOWER_BOUND + 69;
   int RESP_TOPK_COUNT_FUNCTION = RESP_LOWER_BOUND + 70;
   int RESP_TOPK_INFO = RESP_LOWER_BOUND + 71;
