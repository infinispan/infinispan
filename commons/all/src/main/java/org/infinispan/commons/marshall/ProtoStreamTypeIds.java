...
//   int FILE_LIST_CACHE_VALUE = LUCENE_LOWER_BOUND + 5;
   ...
   int RESP_BLOOM_FILTER = RESP_LOWER_BOUND + 35;
   int RESP_BLOOM_SUB_FILTER = RESP_LOWER_BOUND + 36;
   int RESP_BLOOM_INFO = RESP_LOWER_BOUND + 37;
   int RESP_BLOOM_EXISTS_FUNCTION = RESP_LOWER_BOUND + 38;
   int RESP_BLOOM_RESERVE_FUNCTION = RESP_LOWER_BOUND + 39;
   int RESP_BLOOM_INSERT_FUNCTION = RESP_LOWER_BOUND + 40;
   int RESP_BLOOM_INFO_FUNCTION = RESP_LOWER_BOUND + 41;
   int RESP_BLOOM_CARD_FUNCTION = RESP_LOWER_BOUND + 42;
   int RESP_CUCKOO_FILTER = RESP_LOWER_BOUND + 43;
   int RESP_CUCKOO_SUB_FILTER = RESP_LOWER_BOUND + 44;
   int RESP_CUCKOO_EXISTS_FUNCTION = RESP_LOWER_BOUND + 45;
   int RESP_CUCKOO_RESERVE_FUNCTION = RESP_LOWER_BOUND + 46;
   int RESP_CUCKOO_INSERT_FUNCTION = RESP_LOWER_BOUND + 47;
   int RESP_CUCKOO_INFO_FUNCTION = RESP_LOWER_BOUND + 48;
   int RESP_CUCKOO_DEL_FUNCTION = RESP_LOWER_BOUND + 49;
   int RESP_CUCKOO_COUNT_FUNCTION = RESP_LOWER_BOUND + 50;
