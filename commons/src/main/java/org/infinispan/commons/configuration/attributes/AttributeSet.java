...
public class AttributeSet implements AttributeListener<Object> {
   ...
   public <T extends Object> boolean contains(AttributeDefinition<T> def) {
      return contains(def.name());
   }

   @SuppressWarnings("unchecked")
   public <T extends Object> Attribute<T> attribute(String name) {
      return (Attribute<T>) this.attributes.get(name);
   }

   public <T extends Object> Attribute<T> attribute(AttributeDefinition<T> def) {
   ...
   public AttributeSet protect() {
      AttributeDefinition<? extends Object> attrDefs[] = new AttributeDefinition[attributes.size()];
      int i = 0;
      for (Attribute<? extends Object> attribute : attributes.values()) {
   ...
   @Override
   public void attributeChanged(Attribute<Object> newValue, Attribute<Object> oldValue) {
      // TODO
   }
