...
public class AttributeTest {
   ...
   public void testAttributeChanges() {
      ...
      attribute.set(true);
      assertEquals(true, attribute.asBoolean());
   ...
   public void testAttributeListener() {
      ...
      attribute.addListener(new AttributeListener<Boolean>() {
         @Override
         public void attributeChanged(Attribute<Boolean> newValue, Attribute<Boolean> oldValue) {
            assertTrue(newValue.get());
            assertFalse(oldValue.get());
