...
public class UnsafeMemoryAddressOffHeapMemory implements OffHeapMemory {
   ...
   static final ValueLayout.OfInt singleByteAlignedInt = ValueLayout.JAVA_INT.withByteAlignment(1);
   static final ValueLayout.OfLong singleByteAlignedLong = ValueLayout.JAVA_LONG.withByteAlignment(1);
   ...
   public byte getByte(long srcAddress, long offset) {
      ...
      byte value = memorySegment.get(ValueLayout.JAVA_BYTE, offset);
   ...
   public int getInt(long srcAddress, long offset) {
      ...
      int value = memorySegment.get(singleByteAlignedInt,srcAddress + offset);
      if (log.isTraceEnabled()) {
   ...
   public void putInt(long destAddress, long offset, int value) {
      ...
      memorySegment.set(singleByteAlignedInt, destAddress + offset, value);
   }
   ...
   public long getAndSetLong(long destAddress, long offset, long value) {
      ...
      return (long) singleByteAlignedLong.varHandle().getAndSet(memorySegment, destAddress + offset, value);
   }

   public long getAndSetLongNoTraceIfAbsent(long destAddress, long offset, long value) {
      checkAddress(destAddress, offset + 8);
      long previous = (long) singleByteAlignedLong.varHandle().getAndSet(memorySegment, destAddress + offset, value);
      if (previous != 0) {
         if (log.isTraceEnabled()) {
   ...
   private long getLong(long srcAddress, long offset, boolean alwaysTrace) {
      ...
      long value = memorySegment.get(singleByteAlignedLong, srcAddress + offset);
   ...
   public void putLong(long destAddress, long offset, long value) {
      ...
      memorySegment.set(singleByteAlignedLong, destAddress + offset, value);
   }
