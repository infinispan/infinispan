 ...
 *
 * Any violation will be suppressed if it's generated by a source file having {@code /src/test/java}
 * included in its path and if the violation message contains the keyword
