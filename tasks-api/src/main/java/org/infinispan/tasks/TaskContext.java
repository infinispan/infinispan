...
public class TaskContext {
    ...
    /**
     * The cache against which this task will be executed. This will be the task's default cache,
     * but other caches can be obtained from the cache manager
     */
    ...
    /**
     * A map of named parameters that will be passed to the task. Invoking this method overwrites
    ...
    /**
     * The default cache. Other caches can be obtained from cache manager ({@link
