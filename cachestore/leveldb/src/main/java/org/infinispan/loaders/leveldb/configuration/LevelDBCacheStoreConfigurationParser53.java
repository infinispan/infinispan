 ...
 *
 */
public class LevelDBCacheStoreConfigurationParser53 implements ConfigurationParser<ConfigurationBuilderHolder> {
   ...
   public Namespace[] getSupportedNamespaces() {
      return new Namespace[] { new Namespace(Namespace.INFINISPAN_NS_BASE_URI, "leveldb", Element.LEVELDB_STORE.getLocalName(), 5, 3),
