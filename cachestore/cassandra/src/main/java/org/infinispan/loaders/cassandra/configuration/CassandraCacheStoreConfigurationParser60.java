...
/**
 *
 * CassandraCacheStoreConfigurationParser60.
 *
 * @author Galder Zamarreño
 * @since 6.0
 */
@Namespaces({
   @Namespace(uri = "urn:infinispan:config:cassandra:6.0", root = "cassandraStore"),
   @Namespace(root = "cassandraStore"),
})
public class CassandraCacheStoreConfigurationParser60 implements ConfigurationParser {

   public CassandraCacheStoreConfigurationParser60() {
   }
