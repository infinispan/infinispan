...
public class ConfigurationTest {
   ...
   public void testMongoDBConfigurationBuilder() {
      ...
      assert store.host().equals(host);
      assert store.port() == port;
      assert store.timeout() == timeout;
      assert store.username().equals(username);
      assert store.password().equals(password);
      assert store.database().equals(database);
      assert store.collection().equals(collection);
   }
}
