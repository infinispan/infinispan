...
public class JdbcMixedStoreConfigurationBuilder extends AbstractJdbcStoreConfigurationBuilder<JdbcMixedStoreConfiguration, JdbcMixedStoreConfigurationBuilder>
    ...
    * be defaulted to {@link org.infinispan.loaders.jdbc.TableManipulation#DEFAULT_BATCH_SIZE}.
    */
    ...
    * parameter, if not specified will be defaulted to {@link org.infinispan.loaders.jdbc.TableManipulation#DEFAULT_FETCH_SIZE}.
    */
