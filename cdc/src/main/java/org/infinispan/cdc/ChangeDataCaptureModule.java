 ...
 * as adding the database configuration into a cache:
 *
 * <pre>
 * {@code
 ...
 * cache with very-low delays. This avoids the need to externally synchronize the cache or reduces the time with stale
 * data.
 * </p>
 *
 * <h2>Pre-loading</h2>
