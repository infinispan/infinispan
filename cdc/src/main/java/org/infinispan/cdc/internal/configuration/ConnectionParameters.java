...
public record ConnectionParameters(String username, String password, DatabaseURL url) {
   ...
   public static ConnectionParameters create(ConnectionFactory factory) {
   ...
   private static ConnectionParameters create(SimpleConnectionFactory scf) {
   ...
   private static ConnectionParameters create(PooledConnectionFactory pcf) {
   ...
   private static ConnectionParameters create(DataSource dataSource) {
