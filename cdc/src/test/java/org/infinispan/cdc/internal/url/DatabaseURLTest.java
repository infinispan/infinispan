...
import static org.infinispan.cdc.internal.configuration.vendor.DatabaseVendor.SQL_SERVER;
...
public class DatabaseURLTest {
   ...
   static Stream<Arguments> databaseUrlsArguments() {
      return Stream.of(
            ...
            Arguments.arguments("jdbc:oracle:thin:username/password@//127.0.0.1:1234/change-data-capture", ORACLE, "127.0.0.1", "1234", "change-data-capture"),
            Arguments.arguments("jdbc:oracle:thin:@//127.0.0.1:1234/change-data-capture", ORACLE, "127.0.0.1", "1234", "change-data-capture"),
            Arguments.arguments("jdbc:sqlserver://127.0.0.1:1234;encrypt=true;databaseName=change-data-capture;", SQL_SERVER, "127.0.0.1", "1234", "change-data-capture"),
            Arguments.arguments("jdbc:sqlserver://127.0.0.1;encrypt=true;databaseName=change-data-capture;portNumber=1234", SQL_SERVER, "127.0.0.1", "1234", "change-data-capture"),
            Arguments.arguments("jdbc:sqlserver://;encrypt=true;databaseName=change-data-capture;serverName=localhost", SQL_SERVER, DATABASE_DEFAULT_HOST, SQLSERVER_DEFAULT_PORT, "change-data-capture"),
