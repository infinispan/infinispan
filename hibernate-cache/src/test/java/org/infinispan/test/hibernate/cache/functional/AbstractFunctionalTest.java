...
public abstract class AbstractFunctionalTest extends BaseNonConfigCoreFunctionalTestCase {
   ...
   @Override
	public String[] getMappings() {
		return new String[] {
				"hibernate/cache/functional/entities/Item.hbm.xml",
				"hibernate/cache/functional/entities/Customer.hbm.xml",
				"hibernate/cache/functional/entities/Contact.hbm.xml"
		};
	}
