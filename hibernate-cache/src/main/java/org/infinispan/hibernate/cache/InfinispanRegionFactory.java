 ...
 */
package org.infinispan.hibernate.cache;
...
public class InfinispanRegionFactory implements RegionFactory {
	 ...
	 */
	public static final String DEF_INFINISPAN_CONFIG_RESOURCE = "org/infinispan/hibernate/cache/builder/infinispan-configs.xml";

	/**
	 * Default configuration for cases where non-clustered cache manager is provided.
	 */
	public static final String INFINISPAN_CONFIG_LOCAL_RESOURCE = "org/infinispan/hibernate/cache/builder/infinispan-configs-local.xml";
	...
	private void configureTransactionManager(ConfigurationBuilder builder) {
		...
		if (transaction.transactionMode().isTransactional() ) {
			...
			final String hbTmLookupClassName = org.infinispan.hibernate.cache.tm.HibernateTransactionManagerLookup.class.getName();
