...
if [[ ! -e ${ISPN_HOME}/demos/ec2/etc/Amazon-TestData/influenza_aa.dat ]]; then
  gunzip ${ISPN_HOME}/demos/ec2/etc/Amazon-TestData/influenza_aa.dat.gz > /dev/null
fi
...
add_program_args -i "${ISPN_HOME}/demos/ec2/etc/Amazon-TestData/influenza_aa.dat"
