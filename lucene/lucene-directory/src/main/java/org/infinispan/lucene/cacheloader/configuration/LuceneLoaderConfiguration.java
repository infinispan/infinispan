...
public class LuceneLoaderConfiguration extends AbstractStoreConfiguration {
   ...
   public static AttributeSet attributeSet() {
      return new AttributeSet(LuceneLoaderConfiguration.class, AbstractStoreConfiguration.attributeSet(), AUTO_CHUNK_SIZE, LOCATION);
   }
   ...
   public int autoChunkSize() {
      return attributes.attribute(AUTO_CHUNK_SIZE).asInteger();
   }
