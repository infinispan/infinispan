...
public class Key2StringMapperTest {
   ...
   public void testChunkCacheKeyComparison() {
      Assert.assertFalse("The object should not be equals to null.", new ChunkCacheKey("index-A", "fileName", 0, 1024).equals(null));
      Assert.assertFalse("The ChunkCacheKey objects should not be equal due to different file names.",
                         new ChunkCacheKey("index-A", "fileName", 0, 1024).equals(new ChunkCacheKey("index-A", "fileName1", 0, 1024)));
      Assert.assertEquals("The ChunkCacheKey objects should be equal.",
   ...
   public void testReadLockEqualsWithNullOrNotEqualObj() {
      ...
      Assert.assertFalse(new FileReadLockKey("poems and songs, 3000AC-2000DC", "brushed lock")
   ...
   public void testFileListCacheKeyComparison() {
      Assert.assertFalse("The instance of FileListCacheKey should not be equal to null.", new FileListCacheKey("index-A").equals(null));
      Assert.assertFalse("The instance of FileListCacheKey should not be equal to FileCacheKey instance.", new FileListCacheKey("index-A").equals(new FileCacheKey("index-A", "test.txt")));
   }
   ...
   public void testFileCacheKeyCompWithNull() {
      Assert.assertFalse("The Instance of FileCacheKey should not be equal to null.", new FileCacheKey("poems and songs, 3000AC-2000DC", "fileName.txt").equals(null));
   }
}
