...
/**
 * CompositeNotifyingFuture aggregates several NotifyingFuture and completes when all of them
 * complete.
 *
 * @author gustavonalle
 * @since 7.2
