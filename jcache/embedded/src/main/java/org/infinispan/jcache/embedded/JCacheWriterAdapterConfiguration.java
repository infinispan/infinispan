...
public class JCacheWriterAdapterConfiguration extends AbstractStoreConfiguration<JCacheWriterAdapterConfiguration> {

   public JCacheWriterAdapterConfiguration(AttributeSet attributes, AsyncStoreConfiguration async) {
      super(Element.WRITER, attributes, async);
   }
}
