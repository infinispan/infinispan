...
import org.jboss.seam.infinispan.util.CacheHelper;
...
public class CacheHelperTest {
   ...
   public void testGetDefaultMethodCacheName() throws Exception {
      ...
      assertEquals(defaultCacheName, "org.jboss.seam.infinispan.test.util.CacheHelperTest.fooMethod(int,java.lang.String)");
   }
