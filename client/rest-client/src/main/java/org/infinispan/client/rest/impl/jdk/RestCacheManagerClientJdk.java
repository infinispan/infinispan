 ...
 * @since 15.0
 **/
public class RestCacheManagerClientJdk implements RestCacheManagerClient {
   private final RestRawClientJDK client;
   private final String name;
   private final String path;

   RestCacheManagerClientJdk(RestRawClientJDK client, String name) {
      this.client = client;
      this.name = name;
      this.path = client.getConfiguration().contextPath() + "/v2/cache-managers/" + sanitize(name);
   }
