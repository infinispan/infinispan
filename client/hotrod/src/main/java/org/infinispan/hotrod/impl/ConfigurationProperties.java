...
public class ConfigurationProperties {
   ...
   public String getTransactionManagerLookup() {
      return props.getProperty(TRANSACTION_MANAGER_LOOKUP, GenericTransactionManagerLookup.class.getName(), true);
   }
    ...
    */
   public static boolean isVersionPre12(HotRodConfiguration cfg) {
