...
import static org.infinispan.hotrod.configuration.ExecutorFactoryConfiguration.FACTORY;
import static org.infinispan.hotrod.configuration.ExecutorFactoryConfiguration.FACTORY_CLASS;
...
public class ExecutorFactoryConfigurationBuilder extends AbstractConfigurationChildBuilder implements Builder<ExecutorFactoryConfiguration> {
   ...
   public ExecutorFactoryConfigurationBuilder factoryClass(String factoryClass) {
      return factoryClass(Util.loadClass(factoryClass, HotRod.class.getClassLoader()));
   }
