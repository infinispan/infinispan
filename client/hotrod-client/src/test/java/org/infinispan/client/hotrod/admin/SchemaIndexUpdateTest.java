...
public class SchemaIndexUpdateTest extends SingleHotRodServerTest {
   ...
   public void updateWithoutAndWithOtherEntities() {
      ...
      updateSchemaIndex(SchemaB.INSTANCE); // without otherEntities
      ...
      updateSchemaIndex(SchemaC.INSTANCE, "model.Image"); // with otherEntities
   ...
   private void updateSchemaIndex(GeneratedSchema schema, String ... otherIndexedEntities) {
      ...
      remoteCacheManager.administration().updateIndexSchema(CACHE_NAME, otherIndexedEntities);
   }
}
