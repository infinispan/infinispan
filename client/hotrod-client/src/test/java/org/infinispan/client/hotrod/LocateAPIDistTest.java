...
public class LocateAPIDistTest extends MultipleCacheManagersTest {
   ...
   public void testLocate() {
      ...
      assertEquals("Client's locate() method returned different results from the server's locate()!",
            ownerEndpoints, ownersOnClient);
   }
}
