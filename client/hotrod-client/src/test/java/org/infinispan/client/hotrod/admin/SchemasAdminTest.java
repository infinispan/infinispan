...
public class SchemasAdminTest extends SingleHotRodServerTest {
    ...
    public void testDeleteWithValidationOfUse() {
        ...
        RemoteSchemasAdmin.SchemaOpResult deleteResult = adminSchemas.remove("nonExistingFile");
        assertThat(deleteResult.isDeleted()).isFalse();

        assertThatThrownBy(() -> adminSchemas.remove(generatedSchema.getProtoFileName()))
                .isInstanceOf(InfinispanException.class)
    ...
    public void testDeleteWithValidationOfUseAsync() {
        ...
        RemoteSchemasAdmin.SchemaOpResult deleteResult = join(adminSchemas.removeAsync("nonExistingFile"));
        assertThat(deleteResult.isDeleted()).isFalse();
    ...
    public void testCreateOrUpdate() {
        ...
        RemoteSchemasAdmin.SchemaOpResult opResult = schemasAdministration.createOrUpdate(schema);
