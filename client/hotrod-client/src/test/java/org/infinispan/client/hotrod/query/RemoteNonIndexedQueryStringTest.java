...
public class RemoteNonIndexedQueryStringTest extends RemoteQueryStringTest {
   ...
   @Test(expectedExceptions = HotRodClientException.class, expectedExceptionsMessageRegExp = "org.infinispan.query.objectfilter.ParsingException: ISPN028521: Full-text queries cannot be applied to property 'description' in type sample_domain.Transaction unless the property is indexed and analyzed.")
   @Override
