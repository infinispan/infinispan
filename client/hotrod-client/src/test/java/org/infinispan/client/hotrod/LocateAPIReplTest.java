...
public class LocateAPIReplTest extends LocateAPIDistTest {
   ...
   public void testLocate() {
      ...
      for (HotRodServer hrs: Arrays.asList(hotRodServer1, hotRodServer2, hotRodServer3, hotRodServer4)) {
         allEndpoints.add("/" + hrs.getAddress()); // For some reason there is no leading / in the ServerEndpoint's toString()
      }

      assert allEndpoints.equals(ownersOnClient) : "Client's locate() method did not return all endpoints!";
   }
}
