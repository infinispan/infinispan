...
public class ChannelInitializer extends io.netty.channel.ChannelInitializer<Channel> {
   ...
   ChannelInitializer(Bootstrap bootstrap, SocketAddress unresolvedAddress, OperationsFactory operationsFactory, Configuration configuration, ChannelFactory channelFactory, ClusterInfo cluster, SslContext sslContext, boolean alwaysSendPingOnConnect) {
