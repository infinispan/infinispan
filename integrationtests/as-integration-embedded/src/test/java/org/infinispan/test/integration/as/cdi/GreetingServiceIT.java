...
public class GreetingServiceIT {
   ...
   private static Asset manifest() {
      String manifest = Descriptors.create(ManifestDescriptor.class)
            .attribute(
                    "Dependencies", "org.infinispan.cdi:" + Version.getModuleSlot() + " services, " +
                            "org.infinispan.jcache:" + Version.getModuleSlot() + " services, " +
                            //TODO: ISPN-5148 - remove this dependency as soon as WFLY-4250 is fixed.
                            "org.infinispan:" + Version.getModuleSlot())
              .exportAsString();
