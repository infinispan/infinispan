...
import org.infinispan.test.integration.persistence.jdbc.stringbased.JdbcStringParallelIterationIT;
...
public class JdbcStringParallelIterationDeployIT extends JdbcStringParallelIterationIT {

    @Deployment
    @TargetsContainer("server-1")
    public static Archive<?> deployment() {
        WebArchive war = DeploymentHelper.createDeployment();
        war.addClass(JdbcStringParallelIterationIT.class);
        war.addClass(JdbcStringParallelIterationTest.class);
