...
public enum Element {
    ...
    KEY(ModelKeys.KEY),
    KEY_TRANSFORMER(ModelKeys.KEY_TRANSFORMER),
    KEY_TRANSFORMERS(ModelKeys.KEY_TRANSFORMERS),
    STRING_KEYED_JDBC_STORE(ModelKeys.STRING_KEYED_JDBC_STORE),
    IMMUTABLE_CONFIGURATION_STORAGE(ModelKeys.IMMUTABLE_CONFIGURATION_STORAGE),
    ...
    SOFT_INDEX_FILE_STORE(ModelKeys.SOFT_INDEX_FILE_STORE),
    ...
    NON_BLOCKING_THREAD_POOL(ModelKeys.NON_BLOCKING_THREAD_POOL),
    BLOCKING_THREAD_POOL(ModelKeys.BLOCKING_THREAD_POOL),
