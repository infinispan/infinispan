 ...
 */
public class DistributedCacheConfigurationAdd extends SharedStateCacheConfigurationAdd {
    ...
    void processModelNode(OperationContext context, String containerName, String cacheName, ModelNode cache, ConfigurationBuilder builder, List<Dependency<?>> dependencies)
        ...
        final float capacityFactor = (float) DistributedCacheConfigurationResource.CAPACITY_FACTOR.resolveModelAttribute(context,
              cache).asDouble();
