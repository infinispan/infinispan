 ...
 */
public class LocalCacheConfigurationAdd extends CacheConfigurationAdd {

    static final LocalCacheConfigurationAdd INSTANCE = new LocalCacheConfigurationAdd();

    LocalCacheConfigurationAdd() {
