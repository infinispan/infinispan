...
import static org.infinispan.hibernate.cache.commons.InfinispanRegionFactory.DEF_INFINISPAN_CONFIG_RESOURCE;
import static org.infinispan.hibernate.cache.commons.InfinispanRegionFactory.INFINISPAN_CONFIG_RESOURCE_PROP;
import static org.infinispan.hibernate.cache.commons.InfinispanRegionFactory.INFINISPAN_GLOBAL_STATISTICS_PROP;
...
public class DefaultCacheManagerProvider implements EmbeddedCacheManagerProvider {
   ...
   static ConfigurationBuilderHolder loadConfiguration(ServiceRegistry registry, String config) {
