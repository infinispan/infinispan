...
public class QualifierTest extends AbstractFunctionalTest {
   ...
   public void testRegionNamesQualified() {
      ...
      String regionFactoryName = TestRegionFactoryProvider.INSTANCE.getRegionFactoryClass().getName();
      if (!regionFactoryName.contains(".v51.") && !regionFactoryName.contains(".cache.main.")) {
