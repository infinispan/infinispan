 ...
 * {@link RemoteCacheManager} instance.
 * </p>
 * <b>Configuration</b><br/>
 * <p>
 * A <code>RemoteCacheManager</code> is configured through a {@link Properties} object.
 * For an exhaustive list of valid properties to be used see
...
public class InfinispanRemoteCacheManagerFactoryBean extends AbstractRemoteCacheManagerFactory
   ...
   /**
    * {@link RemoteCacheManager#stop()} the
