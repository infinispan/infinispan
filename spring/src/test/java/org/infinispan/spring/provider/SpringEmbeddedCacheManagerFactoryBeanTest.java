...
public class SpringEmbeddedCacheManagerFactoryBeanTest {
   ...
   @Test
   public final void springEmbeddedCacheManagerFactoryBeanShouldAllowOverridingGlobalConfiguration() throws Exception {
   ...
   @Test
   public final void springEmbeddedCacheManagerFactoryBeanShouldAllowOverridingConfigurationBuilder() throws Exception {
   ...
   @Test
   public final void springEmbeddedCacheManagerFactoryBeanShouldAllowOverridingConfigurationWithEmptyInputStream()
         throws Exception {
      objectUnderTest = SpringEmbeddedCacheManagerFactoryBeanBuilder
            .defaultBuilder().build();
