...
public class InfinispanRemoteCacheManagerFactoryBeanTest extends AbstractInfinispanTest {
   ...
   /**
    * Test method for
    * {@link InfinispanRemoteCacheManagerFactoryBean#setKeySizeEstimate(int)}
    * .
    *
    * @throws Exception
    */
   ...
   /**
    * Test method for
    * {@link InfinispanRemoteCacheManagerFactoryBean#setValueSizeEstimate(int)}
    * .
    *
    * @throws Exception
    */
   ...
   /**
    * Test method for
    * {@link InfinispanRemoteCacheManagerFactoryBean#setNearCacheMode(String)}
    *
    * @throws Exception
    */
   @Test
