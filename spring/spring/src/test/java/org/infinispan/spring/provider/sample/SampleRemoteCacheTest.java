...
@ContextConfiguration(locations = "classpath:/org/infinispan/spring/provider/sample/SampleRemoteCacheTestConfig.xml")
public class SampleRemoteCacheTest extends AbstractTestTemplate {
