...
public abstract class AbstractTestTemplate extends AbstractTransactionalTestNGSpringContextTests {
   ...
   public void demonstrateCachePutOnCreate() {
      ...
      assert booksCache().get(bookToCreate.getIsbn()).equals(bookToCreate) : "createBook(" + bookToCreate
   ...
   public void testCreateConditionMet() {
      ...
      assert bookToCreate.equals(booksCache().get(result.getIsbn())) : "createBook(" + bookToCreate
            + ") should have inserted created book into cache";
   }
   ...
   public void testCreateConditionNotMet() {
      ...
      assert !booksCache().containsKey(bookToCreate.getIsbn()) : "createBook(" + bookToCreate
   ...
   public void testCreateUnlessMet() {
      ...
      assert bookToCreate.equals(booksCache().get(bookToCreate.getIsbn())) : "createBook(" + bookToCreate
            + ") should have inserted created book into cache";
   }
   ...
   public void testCachingCreate() {
      ...
      assert bookToCreate.equals(booksCache().get(bookToCreate.getIsbn())) : "createBook(" + bookToCreate
            + ") should have inserted created book into cache";
      assert bookToCreate.equals(backupCache().get(bookToCreate.getIsbn())) : "createBook(" + bookToCreate
            + ") should have inserted created book into cache";
   }
