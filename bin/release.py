...
def switch_to_tag_branch(branch):
...
def release():
  ...
  ## Release order:
  # Step 1: Switch to a temporary branch in Git
  prettyprint("Step 2: Creating temporary branch %s" % (branch), Levels.INFO)
  switch_to_tag_branch(branch)
