...
This is an example comparison of the difference, randomly reading/writing into cache with 2048 entries as executed on 2&times;8-core Intel(R) Xeon(R) CPU E5-2640 v3 @ 2.60GHz:
