...
//Title
= Guide to Infinispan Server Container Images

The Infinispan Server container images runs in a dedicated Java Virtual Machine (JVM) and provides client access to remote caches through Hot Rod or REST endpoints.
