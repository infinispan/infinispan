...
.pom.xml
include::topics/dependencies/lucene_directory.adoc[]
...
.pom.xml
include::topics/dependencies/hibernate_directory_provider.adoc[]
...
.pom.xml
include::topics/dependencies/eap_dependencies.adoc[]
...
When running on {wildflybrandname} with the Java Security Manager enabled, you
might need to security permissions to allow access to resources such as files 
or properties.

For more information, see link:https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.2/html-single/how_to_configure_server_security/index#java_security_manager[Java Security Manager] in the {wildflybrandname} documentation.
endif::productized[]
