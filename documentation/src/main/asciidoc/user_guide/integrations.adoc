...
===  Using Infinispan CDI integration

Infinispan supports both injecting remote and embedded Caches as well as bridging events at Cache and CacheManager level.

For more information, have a look at our link:#cdi_support[CDI paragraph].
