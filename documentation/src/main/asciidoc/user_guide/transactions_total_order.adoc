...
image::images/fig1.png[align="center", title="1-phase commit"]
...
image::images/fig2.png[align="center", title="2-phase commit"]
...
Since 9.0, total order protocol uses the _remote-command-executor_.
...
image::images/fig3.png[align="center", title="Node joining during transaction"]
...
image::images/fig4.png[align="center", title="Total-order broadcast"]
...
image::images/fig5.png[align="center", title="Total-order tx commit"]
...
image::images/Multicast-3-phases.png[align="center", title="Total-order Anycast"]
...
image::images/fig6.png[align="center", title="Transaction commit detail"]
...
image::images/contention.png[align="center", title="Tx contention scenario"]

and the next group of plots the _no contended_ scenario:

image::images/no-contention.png[align="center", title="Tx no-contention scenario"]
