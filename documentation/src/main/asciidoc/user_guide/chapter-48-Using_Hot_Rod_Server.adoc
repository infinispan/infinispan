...
link:$$https://github.com/infinispan/infinispan/blob/6.0.0.Final/client/hotrod-client/src/test/java/org/infinispan/client/hotrod/query/HotRodQueryTest.java$$[HotRodQueryTest]
