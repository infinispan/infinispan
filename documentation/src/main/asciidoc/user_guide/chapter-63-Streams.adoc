...
it has been adapted for Streams. Word count is a classic, if overused, example
...
We can use something akin to the old Collator from Map/Reduce by slightly tweaking
