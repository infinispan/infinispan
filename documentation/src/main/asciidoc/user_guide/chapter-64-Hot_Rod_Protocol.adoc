...
| Parameters size     | byte             | the number of params of the custom filter. Only present when filter converter is provided.
| Parameters          | byte[][]         | an array of parameters, each parameter is a byte array.
