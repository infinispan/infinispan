...
==== upgrade
The _upgrade_ command performs operations used during the rolling upgrade procedure. For a detailed description of this procedure please see <<_Rolling_chapter,Rolling Upgrades>>
