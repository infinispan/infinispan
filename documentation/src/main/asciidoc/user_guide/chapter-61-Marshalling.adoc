...
When using lazy deserialization/storing as binary, keys and values are wrapped as link:$$http://docs.jboss.org/infinispan/6.0/apidocs/org/infinispan/marshall/core/MarshalledValue$$[MarshalledValue]s.
