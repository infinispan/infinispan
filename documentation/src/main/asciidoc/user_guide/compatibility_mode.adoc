...
WARNING: Compatibility mode is schedule for removal in {brandname}, please refer to the <<endpoint.interop, Endpoint Interop guide>> to achieve interoperability between remote endpoints.
