...
For more information about this, please check the java doc in link:$$http://docs.jboss.org/infinispan/6.0/apidocs/org/infinispan/distexec/mapreduce/MapReduceTask.html$$[Map Reduce Task API Documentation]
...
Distributed reduce phase is turned on by using a MapReduceTask link:$$http://docs.jboss.org/infinispan/6.0/apidocs/org/infinispan/distexec/mapreduce/MapReduceTask.html#MapReduceTask(org.infinispan.Cache, boolean)$$[constructor] specifying cache to use as input data for the task and boolean parameter distributeReducePhase set to true. Map/Reduce API link:$$http://docs.jboss.org/infinispan/6.0/apidocs/org/infinispan/distexec/mapreduce/package-summary.html$$[javadoc] and demos are included in distribution.
