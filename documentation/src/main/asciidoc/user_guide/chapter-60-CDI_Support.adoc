...
TIP: There is now a separate module for JSR 107 (JCACHE) integration, including API.  See link:https://docs.jboss.org/author/display/ISPN/Using+Infinispan+as+a+JCache+provider[this chapter] for details.
