...
In order for the above to work, global state must be enabled and a persistent path configured. +PERMANENT+ cache
configurations will be stored in a file named _caches.xml_.
