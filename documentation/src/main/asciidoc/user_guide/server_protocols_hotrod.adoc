...
Please refer to Infinispan Server's link:../server_guide/server_guide.html[documentation] for instructions on how to configure and run a HotRod server.
...
Starting with Infinispan 9.2, the client configuration can be enhanced with a list of regular expressions for classes that are allowed to be read.
