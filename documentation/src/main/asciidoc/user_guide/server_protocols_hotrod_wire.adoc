...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 4.1.0.Final
...
| Version             | 1 byte     | {brandname} hot rod server version.
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 5.1.0.FINAL
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 6.0.0.Final.
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 7.0.0.Final.
...
In {brandname} 5.2, virtual nodes based consistent hashing was abandoned and
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 7.1.0.Final.
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 8.0
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 8.1
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 8.2
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 9.0
...
.{brandname} versions
TIP: This version of the protocol is implemented since {brandname} 9.2
...
In {brandname} 4.2 and earlier, the hash space was hardcoded to 10240, but
...
This hash function was the default one used by the Hot Rod server until {brandname} 4.2.1.
Since {brandname} 5.0, the server never uses hash version 1.
Since {brandname} 9.0, the client ignores hash version 1.

.  Version 2 (single byte, 0x02) Since {brandname} 5.0, a new hash function is
...
Since {brandname} 7.0, the server only uses version 2 for HotRod 1.x clients.

. Version 3 (single byte, 0x03) Since {brandname} 7.0, a new hash function is used by default.
