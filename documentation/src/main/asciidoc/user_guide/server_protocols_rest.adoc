...
public class RestExample {
   ...
   /**
    * Method that puts a String value in cache.
    * @param httpClient HTTP client that is used to send requests and receive responses
    * @param builder    Encapsulates an HTTP request
    * @param value      Text to insert
    * @throws IOException
    * @throws InterruptedException
    */
   public void putMethod(HttpClient httpClient, HttpRequest.Builder builder, String value) throws IOException, InterruptedException {
      System.out.println("----------------------------------------");
      System.out.println("Executing PUT");
      System.out.println("----------------------------------------");

      HttpRequest request = builder.PUT(HttpRequest.BodyPublishers.ofString(value)).build();
   ...
   public static void main(String[] args) throws IOException, InterruptedException {
      ...
      String url = String.format("%s%s", SERVER_ADDRESS, "/rest/default/1");
      ...
      restExample.putMethod(httpClient, builder, "Infinispan REST Test");
      restExample.getMethod(httpClient, builder);
   }
