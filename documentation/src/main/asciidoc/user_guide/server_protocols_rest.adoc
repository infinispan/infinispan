...
* _query_mode_: OPTIONAL the link:#query-clustered-query-api[execution mode] of the query once it's received by server. Valid values are _FETCH_ and _BROADCAST_. Default is _FETCH_.
