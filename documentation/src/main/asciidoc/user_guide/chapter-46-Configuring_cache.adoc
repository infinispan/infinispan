...
Refer to link:http://docs.jboss.org/infinispan/{infinispan-version}/apidocs/org/infinispan/manager/CacheManager.html[CacheManager] , link:http://docs.jboss.org/infinispan/{infinispan-version}/apidocs/org/infinispan/configuration/cache/ConfigurationBuilder.html[ConfigurationBuilder] , link:http://docs.jboss.org/infinispan/{infinispan-version}/apidocs/org/infinispan/configuration/cache/Configuration.html[Configuration] , and link:http://docs.jboss.org/infinispan/{infinispan-version}/apidocs/org/infinispan/configuration/global/GlobalConfiguration.html[GlobalConfiguration] javadocs for more details.
...
Sometimes you might also want to enable collection of link:http://docs.jboss.org/infinispan/{infinispan-version}/apidocs/jmxComponents.html[global JMX statistics]
...
For information on the individual configuration options, please check the link:http://docs.jboss.org/infinispan/{infinispan-version}/configdocs/[configuration guide] .
