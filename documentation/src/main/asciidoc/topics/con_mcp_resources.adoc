...
*Usage*: This resource provides access to the REST API access log, which records all HTTP requests to the {brandname} REST endpoint. Analyze this log to understand API usage patterns, identify performance bottlenecks, detect errors, and monitor client activity. It is also valuable for security auditing to detect denial-of-service attacks or unusual access patterns.
