...
----
include::config_examples/config_eviction_expiration.xml[]
----
...
[source,java]
----
include::code_examples/ConfigEvictionExpiration.java[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/config_expiration_lifespan.xml[]
----

[source,java]
----
include::code_examples/EvictionLifespanExample.java[]
----
