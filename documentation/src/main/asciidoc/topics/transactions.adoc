...
----
include::config_examples/transaction_config.xml[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/versioning_scheme.xml[]
----
...
image::{images_dir}/showInDoubtTx.png[align="center", title="Show in-doubt transactions"]
...
image::{images_dir}/forceCommit.png[align="center", title="Force commit"]
...
image::{images_dir}/total-order-1pc.png[align="center", title="1-phase commit"]
...
image::{images_dir}/total-order-2pc.png[align="center", title="2-phase commit"]
...
image::{images_dir}/total-order-joing-during-st.png[align="center", title="Node joining during transaction"]
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/toa_protocol.xml[]
----
