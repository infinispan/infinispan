...
image::total-order-1pc.png[align="center", title="1-phase commit"]
...
image::total-order-2pc.png[align="center", title="2-phase commit"]
...
image::total-order-joing-during-st.png[align="center", title="Node joining during transaction"]
