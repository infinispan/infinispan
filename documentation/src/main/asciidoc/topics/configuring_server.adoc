...
include::config_examples/jgroups_subsystem.adoc[]
...
include::config_examples/jgroups_default_stack.adoc[]
...
include::config_examples/tcp_ping.adoc[]
...
include::config_examples/jgroups_sasl_auth.adoc[]
...
include::config_examples/jgroups_kerberos_login.adoc[]
...
include::config_examples/ispn_subsystem.adoc[]

=== Containers
The {brandname} subsystem can declare multiple containers. A container is declared as follows:

include::config_examples/ispn_subsystem_containers.adoc[]
...
include::config_examples/ispn_jgroups_transport.adoc[]
...
include::config_examples/ispn_cache_declarations.adoc[]

=== Expiration
To define a default expiration for entries in a cache, add the `<expiration/>` element as follows:

include::config_examples/expiration.adoc[]
...
include::config_examples/eviction.adoc[]
...
include::config_examples/locking.adoc[]
...
include::config_examples/ispn_datasource.adoc[]
...
include::config_examples/ispn_h2_ds.adoc[]
...
include::config_examples/state_transfer.adoc[]
...
include::config_examples/ispn_subsystem_endpoint.adoc[]
...
include::config_examples/hotrod_connector.adoc[]
...
include::config_examples/hotrod_topology_state_transfer.adoc[]
...
include::config_examples/hotrod_security.adoc[]
...
include::config_examples/memcached_connector.adoc[]

=== WebSocket

include::config_examples/websocket_connector.adoc[]

=== REST

include::config_examples/rest_connector.adoc[]
...
include::maven_dependencies/protostuff_marshaller.adoc[]
...
include::maven_dependencies/kyro_marshaller.adoc[]
