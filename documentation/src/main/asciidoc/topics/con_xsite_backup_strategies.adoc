...
* Ignore the failed backup and silently continue the write operation to the local cache.
* Log a warning or throw an exception and continue the write operation to the local cache.
