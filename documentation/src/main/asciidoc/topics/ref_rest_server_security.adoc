...
----
include::json_examples/rest_security_user_acl.json[]
----
...
[source,json,options="nowrap",subs=attributes+]
----
include::json_examples/rest_security_roles.json[]
----

[id='rest_v2_security_roles_principal']
...
[source,json,options="nowrap",subs=attributes+]
----
include::json_examples/rest_security_roles_principal.json[]
----
/v2/security/roles/{principal}

[id='rest_v2_security_roles_principal_grant']
...
[id='rest_v2_security_roles_principal_deny']
