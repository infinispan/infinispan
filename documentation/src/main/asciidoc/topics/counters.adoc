...
.pom.xml
include::maven_dependencies/clustered_counters.adoc[]
...
.configuration.xml
include::config_examples/clustered_counters_config.adoc[]
...
//old_link: NOTE: Hot Rod messages format can be found in link:#hot_rod_protocol_2_7[Hot Rod Protocol 2.7]
