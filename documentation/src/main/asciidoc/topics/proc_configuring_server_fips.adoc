...
= Configuring {brandname} Server on a system with FIPS 140-3 compliant cryptography
...
You can configure your {brandname} Server to use encryption ciphers that adhere to the FIPS 140-3 specification by using alternative JDK security providers.

.Additional resources

* link:https://docs.oracle.com/en/java/javase/17/security/pkcs11-reference-guide1.html[Java PKCS#11 cryptographic provider]
