...
//old_link: link:#tx_locking[Transaction Locking]
...
----
include::config_examples/locking_striping.xml[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/locking_concurrency.xml[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/locking_acquire_timeout.xml[]
----
...
The simple versioning is used in transactional caches for write skew check. Refer to Write Skews for more information.

//old_link: See link:#tx_write_skew[Write Skews].
