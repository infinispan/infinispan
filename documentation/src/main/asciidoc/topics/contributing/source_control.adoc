...
If your topic branch has been open for a while, and you are afraid that changes upstream may clash with your changes, it makes sense to rebase your topic branch before you issue a pull request. To do this:
...
==== Multistep coordination between developers using forked repositories
...
However, occasionally, fixes may apply to both release branches 4.2.x and main. In this case, the following workflow should apply:
