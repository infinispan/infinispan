...
This is recommended when you require the highest consistency as the store will be able to be read again after a crash.
...
This allows for writes to be as fast as without a store, and still maintains consistency.
