...
In this particular scenario, caching data is a way to optimize the system, and it is not desirable that a failure in caching affects the ongoing transaction, hence why failure is handled differently.
