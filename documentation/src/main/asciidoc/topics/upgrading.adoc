...
=== Native Server
The native server and it's associated quay.io/infinispan/server-native images are no longer provided. Instead users should
use the JVM based server as it provides significant performance issues over it's native counterpart and is fully supported.
