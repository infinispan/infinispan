...
== Deprecated JCache managed interceptors
The default set of interceptors now supports both remote caches and injected cache managers
(via custom `CacheResolverFactory` implementations).
