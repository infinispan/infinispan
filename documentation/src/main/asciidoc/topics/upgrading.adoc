...
== XML Configured File Store implementation has changed to be SoftIndexFileStore

The `file-store` element will now install a SoftIndexFileStore instead of the prior SingleFileStore
