...
=== Endpoint `/rest/v2/container/config?action=listen` is deprecated

The endpoint has been deprecated `/rest/v2/container/config?action=listen` and the endpoint `/rest/v2/container?action=listen` has been enhanced with filtering.
Update your code to use `/rest/v2/container?action=listen&category=config` instead.
