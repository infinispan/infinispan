...
----
include::config_examples/atom memory_binary.xml[]
----
...
[source,java]
----
include::code_examples/PersonExternalizer.java[]
----
...
[source,java]
----
include::code_examples/AdvancedExternalizer.java[]
----
...
[source,java]
----
include::code_examples/ExternalizerGetTypeClasses.java[]
----
...
[source,java]
----
include::code_examples/GetTypeClasses.java[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/externalizer_person_class.xml[]
----
...
[source,java]
----
include::code_examples/ExternalizerRegisterPerson.java[]
----
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/externalizer_register_id.xml[]
----
...
[source,java]
----
include::code_examples/ExternalizerRegisterId.java[]
----
...
[source,java]
----
include::code_examples/ExternalizerRegisterMultiple.java[]
----
