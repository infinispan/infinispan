...
link:{configdocroot}index.html[`mode="ASYNC"`]
...
Asynchronous communications are not recommended in general, as they can cause
...
The advantage over using asynchronous communications is that the final value cannot be
