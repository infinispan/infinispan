...
* link:https://infinispan.org/docs/stable/apidocs/org/infinispan/lock/configuration/ClusteredLockManagerConfiguration.html[ClusteredLockManagerConfiguration]

* link:https://infinispan.org/docs/stable/configuration-schema/infinispan-clustered-locks-config-16.1.html[Clustered Locks Configuration Schema]
