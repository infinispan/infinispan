...
If you exceed this character limit, the {brandname} server might abruptly stop without issuing an exception message.
...
* link:http://infinispan.org/schemas/infinispan-config-{schemaversion}.xsd[infinispan-config-{schemaversion}.xsd]
