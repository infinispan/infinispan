...
----
include::config_examples/persistence_custom_store_example.xml[]
----
endif::productized[]
//Include the following configuration in productized docs
ifdef::productized[]
This is the configuration of a custom store:
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/persistence_custom_store_example_notsegmented.xml[]
----
endif::productized[]
...
[source,xml,options="nowrap",subs=attributes+]
----
include::config_examples/persistence_attributes.xml[]
----
...
[source,java]
----
include::code_examples/PersistenceAttributes.java[]
----
