...
= {brandname} Server endpoint IP address filters
...
As a result of the preceding configuration, {brandname} Server accepts connections only from addresses in the `192.168.0.0/16` and `10.0.0.0/8` CIDR blocks.
