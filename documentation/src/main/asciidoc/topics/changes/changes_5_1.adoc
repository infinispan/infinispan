...
link:${javadocroot}/org/infinispan/api/BasicCache.html[`BasicCache`]
and
link:${javadocroot}/org/infinispan/api/BasicCacheContainer.html[`BasicCacheContainer`]
, which are parent classes of existing
link:${javadocroot}/org/infinispan/Cache.html[`Cache`]
and
link:${javadocroot}/org/infinispan/manager/CacheContainer.html[`CacheContainer`]
