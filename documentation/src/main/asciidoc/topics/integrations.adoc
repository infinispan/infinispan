...
.pom.xml
include::maven_dependencies/lucene_directory.adoc[]
...
//old_link: link:#cache_passivation[cache passivation]
...
.pom.xml
include::maven_dependencies/hibernate_directory_provider.adoc[]
...
.pom.xml
include::maven_dependencies/eap_dependencies.adoc[]
...
+
include::config_examples/wfly_extensions.adoc[]
+
...
====
+
include::config_examples/wfly_subsystem.adoc[]
+
ifndef::productized[]
...
+
include::config_examples/wfly_endpoints.adoc[]
endif::productized[]
+
...
====
+
include::config_examples/wfly_jgroups.adoc[]
