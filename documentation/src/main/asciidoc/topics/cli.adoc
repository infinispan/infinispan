...
//old_link: See the link:#data_types[Data Types] section.
...
//old_link: For a detailed description of this procedure please see link:#rolling_upgrades[Rolling Upgrades].
