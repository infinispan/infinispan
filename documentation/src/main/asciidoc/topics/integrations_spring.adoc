...
+
include::config_examples/spring_annotation_driven.adoc[]
+
...
+
include::maven_dependencies/spring_integration.adoc[]
...
+
include::maven_dependencies/spring5_session_dependencies.adoc[]
+
