...
----
FROM sample_domain.Transaction WHERE description : 'cofee'~2
----
...
----
FROM sample_domain.Transaction WHERE amount : [20 to 50]
----
...
----
FROM sample_domain.Transaction WHERE description : 'bus fare'
----
...
----
FROM sample_domain.Transaction WHERE description : 'canceling fee'~3
----
...
----
FROM sample_domain.Transaction where description : 'te?t'
----
...
----
FROM sample_domain.Transaction where description : 'test*'
----
