...
{brandname} provides an experimental API for interacting with your
...
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadOnlyMap.html[`R​eadOnlyMap`]
)​, read­-write (
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadWriteMap.html[`R​eadWriteMap`]
)​ and write­-only (
link:{javadocroot}/org/infinispan/functional/FunctionalMap.WriteOnlyMap.html[`W​riteOnlyMap`]
