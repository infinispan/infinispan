...
.Embedded Mode
include::maven_dependencies/sb_embedded.adoc[]

.Remote Client/Server Mode
include::maven_dependencies/sb_remote.adoc[]
...
include::maven_dependencies/sb_bom.adoc[]
...
include::maven_dependencies/sb_actuator.adoc[]
