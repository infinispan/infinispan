...
interface. This interface allows {brandname} to be extended and modified at various stages of it's lifecycle.
...
. Implementing your custom commands and interceptors to provide your desired functionality
. Add Protostream annotations to your commands to ensure they can be marshalled
