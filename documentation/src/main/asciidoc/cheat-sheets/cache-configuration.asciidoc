...
Eviction::
Eviction controls the amount of data that {brandname} keeps in memory and takes effect for each node. Control the size of data container in one of the following ways:
