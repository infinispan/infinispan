= {brandname} {infinispanversion} documentation index
...
{brandname} provides distributed, in-memory data storage for modern cloud-native application workloads.
...
[discrete]
== Deploying and operating {brandname} clusters

Plan, configure, deploy, and manage {brandname} clusters.

[unstyled]
* link:titles/server/server.html[{brandname} Server Guide]
* link:titles/container_image/container_image.html[{brandname} Server Container Image Guide]
...
* link:titles/upgrading/upgrading.html[Upgrading {brandname} deployments]

[discrete]
== Developing applications with Infinispan

Use {brandname} caching capabilities to boost application performance with a fault-tolerant and elastically scalable data store.
...
* link:titles/hotrod_java/hotrod_java.html[Hot Rod Java clients]
...
* link:titles/memcached/memcached.html[Memcached protocol endpoint with Infinispan]
* link:titles/resp/resp-endpoint.html[Redis-compatible RESP protocol endpoint with Infinispan]
* link:titles/spring/spring.html[Spring Cache and Spring Sessions with Infinispan]
* link:titles/jcache/jcache.html[JCache (JSR-107) API]
* link:titles/mcp_server/mcp_server.html[Model Context Protocol (MCP) Server (experimental)]

[discrete]
== Architecture

[unstyled]
* link:titles/architecture/architecture.html[Architecture Guide]
