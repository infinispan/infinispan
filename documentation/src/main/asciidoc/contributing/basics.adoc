...
{brandname} can be built and run with Java 8, 10 and 11. Be aware, however, that if you want to
run it under Java 10 and later, it needs to be compiled at least with JDK 10, so that certain
version-specific code can be built and enabled.
