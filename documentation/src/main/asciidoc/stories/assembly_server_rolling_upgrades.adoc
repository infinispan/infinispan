...
versions without downtime or data loss.
Rolling upgrades migrate your {brandname} Server instances as well as your data to the target version over Hot Rod.
