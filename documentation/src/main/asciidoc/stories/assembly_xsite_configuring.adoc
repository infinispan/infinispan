...
Configuring {brandname} to replicate data across sites, you first set up cluster transport so {brandname} clusters can discover each other and relay node can communicate.
You then add backup locations to cache definitions in your {brandname} configuration.
