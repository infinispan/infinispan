...
To use a cache from multiple endpoints, it is recommended to store data in binary format and to configure the MediaType for keys and values. More details in http://infinispan.org/docs/dev/user_guide/user_guide.html#endpoint.interop
