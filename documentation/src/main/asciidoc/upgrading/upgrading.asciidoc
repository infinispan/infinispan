...
All Infinispan, Spring and Logger dependencies are now in provided scope. One can decide whether use small jars or uber jars but they need to be added to the classpath on client side.
