...
TIP: New to working with Infinispan and GitHub?  Want to know how best to work with the repositories and contribute code?  Read link:../contributing/contributing.html#source_control[Infinispan and GitHub] 
