 ...
 * <p/>
 * This interface is used to marshall {@link org.infinispan.api.commands.ReplicableCommand}s, their parameters and their
...
public interface Marshaller {
   ...
   /**
    * A method that returns an instance of {@link org.infinispan.api.io.ByteBuffer}, which allows direct access to the byte
