 ...
 */
package org.infinispan.api.manager;
 ...
 * 
 *
 * @see org.infinispan.api.manager.EmbeddedCacheManager
 *
...
public interface BasicCacheContainer extends Lifecycle {
    ...
    * <p/>
    * In the case of a {@link org.infinispan.api.manager.EmbeddedCacheManager}: when creating a new cache, this method will
    * use the configuration passed in to the EmbeddedCacheManager on construction, as a template, and then optionally
    * apply any overrides previously defined for the named cache using the {@link EmbeddedCacheManager#defineConfiguration(String, org.infinispan.api.config.Configuration)}
    * or {@link EmbeddedCacheManager#defineConfiguration(String, String, org.infinispan.api.config.Configuration)}
