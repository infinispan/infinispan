package org.infinispan.scripting.jshell;
...
@Test(groups="functional", testName="scripting.jshell.ScriptingTaskManagerTest")
@CleanupAfterMethod
public class ScriptingTaskManagerTest extends SingleCacheManagerTest {

   protected static final String TEST_SCRIPT = "jshell/test.jshell";
   protected static final String BROKEN_SCRIPT = "jshell/brokenTest.jshell";
