...
public class ScriptingDataStoresTest extends AbstractScriptingTest {
   ...
   protected String[] getScripts() {
      return new String[]{"/js/test.js", "/js/testExecWithoutProp.js"};
   }
   ...
   public void testScriptWithParam() throws Exception {
      String result = (String) scriptingManager.runScript("/js/test.js", new TaskContext().addParameter("a", "a")).get(1000, TimeUnit.MILLISECONDS);
   ...
   public void testScriptWithoutParam() throws Exception {
      ...
      scriptingManager.runScript("/js/testExecWithoutProp.js").get(1000, TimeUnit.MILLISECONDS);
