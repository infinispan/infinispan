...
public class JavaCompiledScript extends CompiledScript {
    ...
    * @param compiledInstance  the instance of the compiled {@link Class} or {@code null} if no instance was created and
    *                          only static methods will be called by the the {@link ExecutionStrategy}.
    ...
    *
    * @return the instance of the compiled {@link Class} or {@code null} if no instance was created and only static
    * methods will be called by the the {@link ExecutionStrategy}.
    */
    ...
    *
    * @return the compiled {@link Class}.
    * @deprecated in release 1.1.0 this method was deprecated, use {@link #getCompiledClass()} instead.
    */
   @Deprecated
    ...
    * @return the instance of the compiled {@link Class} or {@code null} if no instance was created and only static
    * methods will be called by the the {@link ExecutionStrategy}.
    * @deprecated in release 1.1.0 this method was deprecated, use {@link #getCompiledInstance()} instead.
    */
   @Deprecated
