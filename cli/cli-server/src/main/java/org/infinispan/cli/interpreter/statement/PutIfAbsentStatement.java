...
public class PutIfAbsentStatement implements Statement {
   ...
   public PutIfAbsentStatement(final KeyData key, final Object value, final ExpirationData exp) {
      this.keyData = key;
      this.value = value;
      if (exp != null) {
