...
public class BookmarkTest {
   ...
   private static class StubContext implements Context {
      ...
      @Override public boolean isConnected() { return connection != null; }
      @Override public void connect(Shell shell, String connectionString) {}
      @Override public void connect(Shell shell, String connectionString, String username, String password) {}
      @Override public void disconnect() {}
      @Override public String getProperty(String key) { return properties.getProperty(key); }
      @Override public String getProperty(Property key) { return properties.getProperty(key.propertyName()); }
      ...
      @Override public void setSslContext(org.infinispan.cli.impl.SSLContextSettings sslContext) {}
      @Override public Connection getConnection() { return connection; }
      @Override public void setRegistry(org.aesh.command.registry.CommandRegistry registry) {}
      @Override public void setConsole(org.aesh.readline.ReadlineConsole console) {}
      @Override public org.aesh.command.registry.CommandRegistry getRegistry() { return null; }
      @Override public org.infinispan.commons.dataconversion.MediaType getEncoding() { return null; }
      @Override public void setEncoding(org.infinispan.commons.dataconversion.MediaType encoding) {}
      @Override public void refreshPrompt() {}
      @Override public org.aesh.command.CommandResult changeResource(Class<? extends org.infinispan.cli.resources.Resource> fromResource, String resourceType, String name) throws org.aesh.command.CommandException { return null; }
      @Override public org.aesh.io.Resource getCurrentWorkingDirectory() { return null; }
      @Override public void setCurrentWorkingDirectory(org.aesh.io.Resource resource) {}
      @Override public java.util.Set<String> exportedVariableNames() { return java.util.Set.of(); }
      @Override public String exportedVariable(String name) { return null; }
   }
   ...
   private static class StubConnection implements Connection {
      ...
      @Override public String execute(BiFunction<RestClient, Resource, CompletionStage<RestResponse>> op, ResponseMode responseMode) { return null; }
      @Override public Resource getActiveResource() { return null; }
      @Override public void setActiveResource(Resource resource) {}
      @Override public Resource getActiveContainer() { return null; }
      @Override public Collection<String> getAvailableCaches() { return null; }
      @Override public Collection<String> getAvailableContainers() { return null; }
      @Override public Collection<String> getAvailableCounters() { return null; }
      @Override public Collection<String> getAvailableCacheConfigurations() { return null; }
      @Override public Collection<String> getAvailableSchemas() { return null; }
      @Override public Collection<String> getAvailableServers() { return null; }
      @Override public Collection<String> getAvailableSites(String cache) { return null; }
      @Override public Collection<String> getAvailableTasks() { return null; }
      @Override public Iterable<Map<String, String>> getCacheKeys(String cache) { return null; }
      @Override public Iterable<Map<String, String>> getCacheKeys(String cache, int limit) { return null; }
      @Override public Iterable<Map<String, String>> getCacheEntries(String cache, int limit, boolean metadata) { return null; }
      @Override public Iterable<String> getCounterValue(String counter) { return null; }
      @Override public boolean isConnected() { return true; }
      @Override public String describeContainer() { return null; }
      @Override public String describeCache(String cache) { return null; }
      @Override public String describeKey(String cache, String key) { return null; }
      @Override public String describeConfiguration(String configuration) { return null; }
      @Override public String describeCounter(String counter) { return null; }
      @Override public String describeTask(String taskName) { return null; }
      @Override public String getConnectionInfo() { return null; }
      @Override public String getServerVersion() { return null; }
      @Override public Collection<String> getClusterNodes() { return null; }
      @Override public Collection<String> getAvailableLogAppenders() { return null; }
      @Override public Collection<String> getAvailableLoggers() { return null; }
      @Override public Collection<String> getBackupNames() { return null; }
      @Override public Collection<String> getSitesView() { return null; }
      @Override public String getLocalSiteName() { return null; }
      @Override public boolean isRelayNode() { return false; }
      @Override public Collection<String> getRelayNodes() { return null; }
      @Override public Collection<String> getConnectorNames() { return null; }
      @Override public MediaType getEncoding() { return null; }
      @Override public void setEncoding(MediaType encoding) {}
      @Override public void refreshServerInfo() {}
      @Override public Collection<String> getDataSourceNames() { return null; }
      @Override public Collection<String> getCacheConfigurationAttributes(String name) { return null; }
      @Override public Collection<String> getRoles() { return null; }
      @Override public void close() {}
   }

   private static class StubCommandInvocation implements CommandInvocation {
      private final Shell shell;

      StubCommandInvocation(Shell shell) {
         this.shell = shell;
      }

      @Override public Shell getShell() { return shell; }
      @Override public void setPrompt(Prompt prompt) {}
      @Override public Prompt getPrompt() { return null; }
      @Override public String getHelpInfo(String commandName) { return ""; }
      @Override public String getHelpInfo() { return ""; }
      @Override public void stop() {}
      @Override public CommandInvocationConfiguration getConfiguration() { return null; }
      @Override public KeyAction input() { return null; }
      @Override public KeyAction input(long timeout, TimeUnit unit) { return null; }
      @Override public String inputLine() { return null; }
      @Override public String inputLine(Prompt prompt) { return null; }
      @Override public void executeCommand(String input) {}
      @Override public Executor buildExecutor(String line) { return null; }
      @Override public void print(String msg) { shell.write(msg, false); }
      @Override public void println(String msg) { shell.writeln(msg, false); }
      @Override public void print(String msg, boolean paging) { shell.write(msg, paging); }
      @Override public void println(String msg, boolean paging) { shell.writeln(msg, paging); }
   }
}
