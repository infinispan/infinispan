 ...
 * @since 15.0
 **/
@CommandDefinition(name = Principals.CMD, description = "Performs operations on principals", activator = ConnectionActivator.class, groupCommands = {Principals.Ls.class})
