...
@CommandDefinition(name = "cd", description = "Selects a subsytem/item", activator = ConnectionActivator.class)
public class CD extends CliCommand {
   ...
   public CommandResult exec(ContextAwareCommandInvocation invocation) {
      CommandInputLine cmd = new CommandInputLine("cd").arg("name", name);
