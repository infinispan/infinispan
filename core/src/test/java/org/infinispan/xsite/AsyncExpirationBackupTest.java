...
public class AsyncExpirationBackupTest extends AbstractTwoSitesTest {
   ...
   public Object[] factory() {
      List<AsyncExpirationBackupTest> tests = new LinkedList<>();
      for (ConfigMode lon : ConfigMode.values()) {
         for (ConfigMode nyc : ConfigMode.values()) {
            tests.add(new AsyncExpirationBackupTest().setLonConfigMode(lon).setNycConfigMode(nyc));
         }
      }
   ...
   public AsyncExpirationBackupTest() {
   ...
   private AsyncExpirationBackupTest setLonConfigMode(ConfigMode configMode) {
      this.lonConfigMode = configMode;
      return this;
   }

   private AsyncExpirationBackupTest setNycConfigMode(ConfigMode configMode) {
