...
public class FrameworkFailure<T> implements IInstanceInfo<T> {
   ...
   public FrameworkFailure(Class<T> testClass, String format, Object... args) {
      this(testClass, new TestNGException(String.format(format, args)));
   }

   public FrameworkFailure(Class<T> testClass, Throwable t) {
