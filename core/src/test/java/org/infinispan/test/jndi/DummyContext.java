...
public class DummyContext implements Context {
    ...
    * @throws javax.naming.NameAlreadyBoundException if <code>newName</code> is already bound
    * @throws NamingException                        if a naming exception is encountered
    ...
    * @throws javax.naming.NameNotFoundException    if an intermediate context does not exist
    * @throws javax.naming.NotContextException      if the name is bound but does not name a context, or does not name a context of the
    *                                               appropriate type
