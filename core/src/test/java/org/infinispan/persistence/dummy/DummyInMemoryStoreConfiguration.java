...
public class DummyInMemoryStoreConfiguration extends AbstractStoreConfiguration {
   ...
   public static AttributeSet attributeSet() {
      return new AttributeSet(DummyInMemoryStore.class, AbstractStoreConfiguration.attributeSet(), DEBUG, SLOW, STORE_NAME, FAIL_KEY);
   }
   ...
   public boolean debug() {
      return attributes.attribute(DEBUG).asBoolean();
   }

   public boolean slow() {
      return attributes.attribute(SLOW).asBoolean();
   }

   public String storeName() {
      return attributes.attribute(STORE_NAME).asString();
   }
