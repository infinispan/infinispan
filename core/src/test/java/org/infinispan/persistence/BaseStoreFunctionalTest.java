...
public abstract class BaseStoreFunctionalTest extends SingleCacheManagerTest {
   ...
   public void testUpdateResetsLifespanWriteOnlyEval() {
      doTestUpdateResetsLifespan("testUpdateResetsLifespanWriteOnlyEval", cache -> {
         WriteOnlyMap<String, Object> wo = WriteOnlyMapImpl.create(FunctionalMapImpl.create(cache.getAdvancedCache()));
   ...
   public void testUpdateResetsLifespanReadWriteEval() {
      doTestUpdateResetsLifespan("testUpdateResetsLifespanReadWriteEval", cache -> {
         ReadWriteMap<String, Object> rw = ReadWriteMapImpl.create(FunctionalMapImpl.create(cache.getAdvancedCache()));
