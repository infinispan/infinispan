...
public class InternalMetadataTest {
   ...
   private class TestMetadata implements Metadata, Metadata.Builder {
      ...
      @Override
      public Builder invocation(CommandInvocationId id, Object returnValue, boolean authoritative, boolean created, boolean modified, boolean removed, long timestamp) {
         return this;
      }
