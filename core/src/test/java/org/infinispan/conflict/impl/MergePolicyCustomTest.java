...
public class MergePolicyCustomTest extends BaseMergePolicyTest {
   ...
   public Object[] factory() {
      return new Object[] {
            new MergePolicyCustomTest().setPartitions("5N", new int[]{0,1,2}, new int[]{3,4}),
            new MergePolicyCustomTest().setPartitions("4N", new int[]{0,1}, new int[]{2,3}),
            new MergePolicyCustomTest().setPartitions("3N", new int[]{0,1}, new int[]{2})
      };
   }
