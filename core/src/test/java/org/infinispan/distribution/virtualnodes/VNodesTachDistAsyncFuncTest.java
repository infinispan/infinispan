 ...
 * @since 4.2
 */
@Test (groups = "functional", testName = "topologyaware.VNodesTachDistAsyncFuncTest")
public class VNodesTachDistAsyncFuncTest extends DistAsyncFuncTest {

   public VNodesTachDistAsyncFuncTest() {
      numVirtualNodes = 10;
   }
