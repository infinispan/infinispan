 ...
 * @since 9.4
 */
@Test(groups = "functional", testName = "expiration.impl.CustomLoaderNonNullWithExpiration")
public class CustomLoaderNonNullWithExpiration extends SingleCacheManagerTest {
