...
public class ForceSyncAsyncFlagsTest extends MultipleCacheManagersTest {
   ...
   public void testForceAsyncFlagUsage() throws Exception {
      ...
      verify(mockTransport)
            .invokeCommandOnAll(isA(SingleRpcCommand.class), any(ResponseCollector.class), any(DeliverOrder.class),
      ...
      verify(mockTransport)
            .sendToAll(isA(SingleRpcCommand.class), any(DeliverOrder.class));
   }
