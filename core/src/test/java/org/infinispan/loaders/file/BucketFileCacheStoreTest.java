...
public class BucketFileCacheStoreTest extends BaseCacheStoreTest {

   BucketFileCacheStore fcs;
   String tmpDirectory;
   ...
   public void testPurgeExpired() throws Exception {
      ...
      cs.purgeExpired();
      BucketFileCacheStore fcs = (BucketFileCacheStore) cs;
   ...
   public void testNumericNamedFilesFilter() {
      File dir = new File(".");
      assert BucketFileCacheStore.NUMERIC_NAMED_FILES_FILTER.accept(dir, "-123456789");
      assert BucketFileCacheStore.NUMERIC_NAMED_FILES_FILTER.accept(dir, "987654321");
      assert !BucketFileCacheStore.NUMERIC_NAMED_FILES_FILTER.accept(dir, ".nfs1234");
      assert !BucketFileCacheStore.NUMERIC_NAMED_FILES_FILTER.accept(dir, "12345678901");
   }
}
