...
public class EvictionWithConcurrentOperationsTest extends SingleCacheManagerTest {
   ...
   public void testScenario3() throws Exception {
      ...
      final Object key2 = new SameHashCodeKey("key2");
      final Latch latch = new Latch();
      cache.addListener(new BlockOnKeyEvictionListener(key1, latch));
   ...
   public void testScenario4() throws Exception {
      ...
      cache.addListener(new BlockOnKeyEvictionListener(key1, writeLatch));
   ...
   protected void configurePersistence(ConfigurationBuilder builder) {
      builder.loaders().passivation(false).addStore(DummyInMemoryCacheStoreConfigurationBuilder.class)
   ...
   @Listener(sync = true)
   public static class BlockOnKeyEvictionListener {

      private final Object key;
      private final Latch latch;

      public BlockOnKeyEvictionListener(Object key, Latch latch) {
         this.key = key;
         this.latch = latch;
      }
      ...
      public void evicted(CacheEntriesEvictedEvent event) {
         if (event.getEntries().containsKey(key)) {
            latch.blockIfNeeded();
         }
      }
   }
