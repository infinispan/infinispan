...
public class ComponentRegistryTrackerTest {
   ...
   public void testTimeTrackingGlobal() {
      ...
      try {
         ...
         assertThat(blame)
               .contains("instantiating: 1000")
               .contains("instantiated: 1100")
               .contains("wiring: 1200")
               .contains("wired: 1300")
               .contains("starting: 1400")
               .contains("total: 6000");
   ...
   public void testTimeTrackingSkippingStages(BasicComponentRegistryImpl.WrapperState[] states) {
      ...
      try {
         ...
         assertThat(tracker.dump()).contains("total: " + (1_000 + 1_000 * states.length));
      } finally {
         globalRegistry.stop();
      }
   }
