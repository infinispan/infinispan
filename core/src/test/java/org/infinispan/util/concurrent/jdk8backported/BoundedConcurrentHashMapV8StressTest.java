...
public void testNoEvictionRemovePerformance() {
   ...
   testRemovePerformance(COUNT, new BoundedConcurrentHashMapV8<Integer, Integer>(
         COUNT, COUNT >> 1, lru, 
         BoundedConcurrentHashMapV8.getNullEvictionListener()), lru.toString());
}
...
public void testLRURemovePerformance() {
   ...
   public void testLIRSRemovePerformance() {
      ...
      testRemovePerformance(COUNT, new BoundedConcurrentHashMapV8<Integer, Integer>(
            COUNT, COUNT >> 1, lirs, 
            BoundedConcurrentHashMapV8.getNullEvictionListener()), lirs.toString());
   }
}
