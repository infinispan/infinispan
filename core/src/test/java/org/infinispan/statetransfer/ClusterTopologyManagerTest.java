...
public class ClusterTopologyManagerTest extends MultipleCacheManagersTest {
   ...
   public void testNodeAbruptLeave() throws Exception {
      ...
      TestingUtil.waitForRebalanceToComplete(c1, c2);
      TestingUtil.waitForRebalanceToComplete(c3);

      TestingUtil.waitForRebalanceToComplete(cache(0, "cache2"), cache(1, "cache2"));
      TestingUtil.waitForRebalanceToComplete(cache(0, "cache3"));
      TestingUtil.waitForRebalanceToComplete(cache(1, "cache4"));
      TestingUtil.waitForRebalanceToComplete(cache(0, "cache5"), cache(1, "cache5"));
      ...
      TestingUtil.waitForRebalanceToComplete(c1, c2, c4);
      ...
      cache(3, "cache4");
      cache(3, "cache5");
      TestingUtil.waitForRebalanceToComplete(cache(0, "cache2"), cache(1, "cache2"), cache(3, "cache2"));
      TestingUtil.waitForRebalanceToComplete(cache(0, "cache3"), cache(3, "cache3"));
      TestingUtil.waitForRebalanceToComplete(cache(1, "cache4"), cache(3, "cache4"));
      TestingUtil.waitForRebalanceToComplete(cache(0, "cache5"), cache(1, "cache5"), cache(3, "cache5"));
   }
   ...
   public void testClusterRecoveryAfterCoordLeave() throws Exception {
      ...
      TestingUtil.waitForRebalanceToComplete(c1);
      TestingUtil.waitForRebalanceToComplete(c2, c3);
      ...
      TestingUtil.waitForRebalanceToComplete(c2, c3, c4);
   }
   ...
   public void testClusterRecoveryAfterThreeWaySplit() throws Exception {
      ...
      TestingUtil.blockUntilViewsReceived(30000, false, c3);
      TestingUtil.waitForRebalanceToComplete(c1);
      TestingUtil.waitForRebalanceToComplete(c2);
      TestingUtil.waitForRebalanceToComplete(c3);
      ...
      TestingUtil.waitForRebalanceToComplete(c1, c2, c3);
      ...
      TestingUtil.waitForRebalanceToComplete(c1, c2, c3, c4);
   }
   ...
   public void testClusterRecoveryWithRebalance() throws Exception {
      ...
      TestingUtil.waitForRebalanceToComplete(c1, c2, c3, c4, c5);
   }
   ...
   public void testJoinerBecomesOnlyMember() {
      ...
      TestingUtil.blockUntilViewsReceived(30000, false, manager(1));
      TestingUtil.waitForRebalanceToComplete(cache(1, OTHER_CACHE_NAME));
   }
}
