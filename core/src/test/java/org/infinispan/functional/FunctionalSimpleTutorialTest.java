...
public class FunctionalSimpleTutorialTest extends SingleCacheManagerTest {
   ...
   public void testSimpleTutorial() throws Exception {
      ...
      FunctionalMap<String, String> functionalMap = FunctionalMap.create(cache);
      WriteOnlyMap<String, String> writeOnlyMap = functionalMap.toWriteOnlyMap();
      ReadOnlyMap<String, String> readOnlyMap = functionalMap.toReadOnlyMap();
      ...
      ReadWriteMap<String, String> readWriteMap = functionalMap.toReadWriteMap();
