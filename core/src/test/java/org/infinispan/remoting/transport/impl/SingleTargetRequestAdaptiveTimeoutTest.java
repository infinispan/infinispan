...
@Test(groups = "unit", testName = "remoting.transport.impl.SingleTargetRequestAdaptiveTimeoutTest")
public class SingleTargetRequestAdaptiveTimeoutTest {
   ...
   public void healthyTrackerUsesFullTimeout() {
   ...
   public void degradedTrackerUsesReducedTimeout() {
      AdaptiveTimeout adaptive = new AdaptiveTimeout();
      for (int i = 0; i < 20; i++) {
         adaptive.recordSuccess(10 * MS);
      }
   ...
   public void partiallyDegradedTrackerInterpolates() {
      AdaptiveTimeout adaptive = new AdaptiveTimeout();
      for (int i = 0; i < 20; i++) {
         adaptive.recordSuccess(10 * MS);
      }
   ...
   public void multiTargetEarlyCompletionReleasesAbandonedTrackers() {
   ...
   public void cancelledSingleTargetRequestReleasesTracker() {
      Address target = Address.random("target");
   ...
   public void singleTargetLeaverAbandonsTrackerWithoutRecording() {
      Address target = Address.random("target");
