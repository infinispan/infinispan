...
@Test(groups = "unit", testName = "remoting.transport.jgroups.JGroupsMetricsManagerGaugesTest")
public class JGroupsMetricsManagerGaugesTest {

   public void roundTripTimeGaugeReadsSmoothedRtt() {
      String dst = "node-a";
   ...
   public void roundTripTimeVarianceGaugeReadsRttVariance() {
      String dst = "node-a";
      AdaptiveTimeout adaptiveTimeout = new AdaptiveTimeout();
   ...
   public void tokenBucketLevelGaugeReadsBucketLevel() {
      String dst = "node-a";
      AdaptiveTimeout adaptiveTimeout = new AdaptiveTimeout();
   ...
   public void inFlightRequestsGaugeReadsInFlightCount() {
      String dst = "node-a";
      AdaptiveTimeout adaptiveTimeout = new AdaptiveTimeout();
   ...
   public void concurrencyLimitGaugeReadsConcurrencyLimit() {
      String dst = "node-a";
      AdaptiveTimeout adaptiveTimeout = new AdaptiveTimeout();
