...
public class VersionAwareMarshallerTest extends AbstractInfinispanTest {
   ...
   public void testTransactionLogMarshalling() throws Exception {
      GlobalTransaction gtx = gtf.newGlobalTransaction(new JGroupsAddress(new IpAddress(12345)), false);
      PutKeyValueCommand command = new PutKeyValueCommand("k", "v", false, null, 0, 0, null, Collections.EMPTY_SET);
   ...
   public void testReplicableCommandsMarshalling() throws Exception {
      ...
      ClusteredGetCommand c2 = new ClusteredGetCommand("key", "mycache", null, Collections.EMPTY_SET);
      ...
      GetKeyValueCommand c4 = new GetKeyValueCommand("key", new Address() {}, null, Collections.EMPTY_SET);
      ...
      PutKeyValueCommand c5 = new PutKeyValueCommand("k", "v", false, null, 0, 0, null, Collections.EMPTY_SET);
      ...
      RequestInvalidateL1Command c18 = new RequestInvalidateL1Command(null, "key1", "key2");
      bytes = marshaller.objectToByteBuffer(c18);
      RequestInvalidateL1Command rc18 = (RequestInvalidateL1Command) marshaller.objectFromByteBuffer(bytes);
      assert rc18.getCommandId() == c18.getCommandId() : "Writen[" + c18.getCommandId() + "] and read[" + rc18.getCommandId() + "] objects should be the same";
      assert Arrays.equals(rc18.getParameters(), c18.getParameters()) : "Writen[" + c18.getParameters() + "] and read[" + rc18.getParameters() + "] objects should be the same";
   ...
   public void testNestedNonSerializable() throws Exception {
      PutKeyValueCommand cmd = new PutKeyValueCommand("k", new Object(), false, null, 0, 0, null, Collections.EMPTY_SET);
      try {
