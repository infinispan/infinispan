...
public class ConfigurationUnitTest {
   ...
   public void testSchema() throws Exception {
      ...
      URL schemaFile = aggregateClassLoader.lookupFileLocation("schema/infinispan-config-6.0.xsd");
      Source xmlFile = new StreamSource(aggregateClassLoader.lookupFile("configs/all.xml", null));
