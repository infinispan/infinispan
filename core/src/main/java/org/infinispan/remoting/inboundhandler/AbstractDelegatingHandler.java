...
public abstract class AbstractDelegatingHandler implements PerCacheInboundInvocationHandler {
     ...
     *
     * @return {@code true} if the command should be handled by the read {@link
     * org.infinispan.remoting.inboundhandler.PerCacheInboundInvocationHandler}, {@code false}
     * otherwise.
     */
     ...
     *
     * @param delegated {@code true} if the command was handled by the real {@link
     * org.infinispan.remoting.inboundhandler.PerCacheInboundInvocationHandler}, {@code false}
     * otherwise.
     */
