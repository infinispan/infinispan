...
public class UnsuccessfulResponse extends ValidResponse {
   public static final UnsuccessfulResponse UNSUCCESSFUL_EMPTY_RESPONSE = new UnsuccessfulResponse(null);
   ...
   public static UnsuccessfulResponse create(Object value) {
      return value == null ? UNSUCCESSFUL_EMPTY_RESPONSE : new UnsuccessfulResponse(value);
   }
