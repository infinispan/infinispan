...
public class CommandAwareRpcDispatcher extends MessageDispatcher {
   ...
   public static final short REPLY_FLAGS_TO_CLEAR =
         (short) (Message.Flag.RSVP.value() | Message.Flag.INTERNAL.value() | Message.Flag.NO_TOTAL_ORDER.value());
   public static final short REPLY_FLAGS_TO_SET = NO_FC.value();
