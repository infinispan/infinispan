...
/**
 * Configures {@link KarstenFileCacheStore}.
 * <p/>
 * <ul>
 ...
 */
public class KarstenFileCacheStoreConfig extends AbstractCacheStoreConfig {
   ...
   public KarstenFileCacheStoreConfig() {
      setCacheLoaderClassName(KarstenFileCacheStore.class.getName());
   }
   ...
   public KarstenFileCacheStoreConfig location(String location) {
   ...
   public KarstenFileCacheStoreConfig maxEntries(int maxEntries) {
