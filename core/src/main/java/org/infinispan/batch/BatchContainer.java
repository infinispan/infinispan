...
/**
 * A container for holding thread locals for batching, to be used with the {@link
 * org.infinispan.Cache#startBatch()} and {@link org.infinispan.Cache#endBatch(boolean)} calls.
 *
