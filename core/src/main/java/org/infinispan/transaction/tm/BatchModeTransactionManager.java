...
/**
 * Not really a transaction manager in the truest sense of the word.  Only used to batch up
 * operations.  Proper transactional semantics of rollbacks and recovery are NOT used here.
 *
 * @author bela
 * @since 4.0
 */
