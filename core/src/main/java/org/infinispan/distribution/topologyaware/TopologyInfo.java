...
public class TopologyInfo {
    ...
    private List<Address> sortMembers(Collection<Address> members,
     ...
     */
    private double computeMaxSegmentsForNode(int numSegments, double numCopies,
    ...
    public float computeTotalCapacity(Collection<Address> nodes,
    ...
    private double computeMaxSegmentsForMachine(int numSegments, double numCopies,
    ...
    private double computeMaxSegmentsForRack(int numSegments, double numCopies,
        Collection<Rack> racks, Rack rack,
        Machine machine, Address node) {
    ...
    private double computeMaxSegmentsForSite(int numSegments, double numCopies,
