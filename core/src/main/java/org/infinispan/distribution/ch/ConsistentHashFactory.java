...
public interface ConsistentHashFactory<CH extends ConsistentHash> {
     ...
     * @param numOwners The ideal number of owners for each key. The created consistent hash can have more or less
     * owners, but each key will have at least one owner.
     * @param numSegments Number of hash-space segments. The implementation may round up the number of segments for
     * performance, or may ignore the parameter altogether.
     ...
     * to the others. The implementation may ignore this parameter. If {@code null}, all the members are assumed to have
     * a capacity factor of 1.
     */
     ...
     * to the others. The implementation may ignore this parameter. If {@code null}, all the members are assumed to have
     * a capacity factor of 1.
     * @return A new {@link ConsistentHash} instance, or {@code baseCH} if the existing instance does not need any
     * changes.
     */
