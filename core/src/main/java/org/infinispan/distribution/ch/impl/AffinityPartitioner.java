...
/**
 * Key partitioner that maps keys to segments using information contained in {@link AffinityTaggedKey}. <p>If the
 * segment is not defined (value -1) or the key is not an AffinityTaggedKey, will fallback to a {@link
