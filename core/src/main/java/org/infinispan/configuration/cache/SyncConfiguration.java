...
public class SyncConfiguration {
   ...
   static final AttributeDefinition<Long> REPL_TIMEOUT = AttributeDefinition.builder("replTimeout", TimeUnit.SECONDS.toMillis(15)).build();
   ...
   public long replTimeout() {
      return attributes.attribute(REPL_TIMEOUT).asLong();
   }
