...
public class StateTransferConfigurationBuilder extends
   ...
   StateTransferConfigurationBuilder(ClusteringConfigurationBuilder builder) {
      super(builder);
      attributes = StateTransferConfiguration.attributeSet();
   }
   ...
   public void validate() {
      if (attributes.attribute(CHUNK_SIZE).asInteger() <= 0) {
      ...
      if (awaitInitialTransfer.isModified() && awaitInitialTransfer.asBoolean()
