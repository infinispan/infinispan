...
import static org.infinispan.configuration.cache.XSiteStateTransferConfiguration.CHUNKSIZE;
import static org.infinispan.configuration.cache.XSiteStateTransferConfiguration.MAXRETRIES;
import static org.infinispan.configuration.cache.XSiteStateTransferConfiguration.TIMEOUT;
import static org.infinispan.configuration.cache.XSiteStateTransferConfiguration.WAITTIME;
...
public class XSiteStateTransferConfigurationBuilder extends AbstractConfigurationChildBuilder
   ...
   public static final int DEFAULT_CHUNK_SIZE = CHUNKSIZE.getDefaultValue();
   public static final long DEFAULT_TIMEOUT = TIMEOUT.getDefaultValue();
   public static final int DEFAULT_MAX_RETRIES = MAXRETRIES.getDefaultValue();
   public static final long DEFAULT_WAIT_TIME = WAITTIME.getDefaultValue();
   ...
   public final XSiteStateTransferConfigurationBuilder chunkSize(int chunkSize) {
      attributes.attribute(CHUNKSIZE).set(chunkSize);
      return this;
   }
   ...
   public final XSiteStateTransferConfigurationBuilder maxRetries(int maxRetries) {
      attributes.attribute(MAXRETRIES).set(maxRetries);
      return this;
   }
   ...
   public final XSiteStateTransferConfigurationBuilder waitTime(long waitingTimeBetweenRetries) {
      attributes.attribute(WAITTIME).set(waitingTimeBetweenRetries);
      return this;
   }
