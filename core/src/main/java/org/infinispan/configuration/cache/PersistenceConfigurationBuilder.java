...
import static org.infinispan.configuration.cache.PersistenceConfiguration.*;
/**
...
public class PersistenceConfigurationBuilder extends AbstractConfigurationChildBuilder implements Builder<PersistenceConfiguration> {
   ...
   protected PersistenceConfigurationBuilder(ConfigurationBuilder builder) {
      super(builder);
      attributes = PersistenceConfiguration.attributeSet();
   }
    ...
    */
   boolean passivation() {
      return attributes.attribute(PASSIVATION).asBoolean();
   }
