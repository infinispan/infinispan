...
public class ClusteringConfiguration {
   static final AttributeDefinition<CacheMode> CACHE_MODE = AttributeDefinition.builder("cacheMode",  CacheMode.LOCAL).immutable().build();
   ...
   public CacheMode cacheMode() {
      return attributes.attribute(CACHE_MODE).asObject(CacheMode.class);
   }
