...
public class StateTransferConfiguration extends ConfigurationElement<StateTransferConfiguration> {
   ...
   public static final AttributeDefinition<Boolean> AWAIT_LEAVE_TRANSFER = AttributeDefinition.builder(org.infinispan.configuration.parsing.Attribute.AWAIT_LEAVE_TRANSFER, false)
         .since(16, 3)
         .global(false)
         .build();
