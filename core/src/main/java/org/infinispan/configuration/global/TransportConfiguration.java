...
public class TransportConfiguration {
   ...
   private final ThreadPoolConfiguration threadPool;
   ...
   TransportConfiguration(String clusterName, String machineId, String rackId, String siteId,
         ...
         ThreadPoolConfiguration threadPool, ThreadPoolConfiguration remoteCommandThreadPool,
   ...
   public ThreadPoolConfiguration threadPool() {
      return threadPool;
   }
   ...
   public String toString() {
      return "TransportConfiguration{" +
            ...
            ", executor=" + threadPool +
            ", remoteCommandExecutorName=" + remoteCommandThreadPool +
            ", totalOrderExecutorName=" + totalOrderThreadPool +
            '}';
   }
