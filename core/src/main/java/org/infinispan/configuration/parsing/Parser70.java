...
public class Parser70 implements ConfigurationParser {
   ...
   private void parseScheduledThreadPool(XMLExtendedStreamReader reader, ConfigurationBuilderHolder holder) throws XMLStreamException {
      ...
      ThreadPoolExecutorFactory factory = new ScheduledThreadPoolExecutorFactory();
      builder.threadPoolFactory(factory);
   ...
   private void parseCachedThreadPool(XMLExtendedStreamReader reader, ConfigurationBuilderHolder holder) throws XMLStreamException {
      ...
      ThreadPoolExecutorFactory factory = new CachedThreadPoolExecutorFactory();
      builder.threadPoolFactory(factory);
   ...
   private void parseTransport(XMLExtendedStreamReader reader, ConfigurationBuilderHolder holder) throws XMLStreamException {
      ...
      for (int i = 0; i < reader.getAttributeCount(); i++) {
         ...
         switch (attribute) {
            ...
            case EXECUTOR: {
               globalBuilder.transport().threadPool().read(
   ...
   private void parseLocalCache(XMLExtendedStreamReader reader, ConfigurationBuilderHolder holder) throws XMLStreamException {
      ...
      for (int i = 0; i < reader.getAttributeCount(); i++) {
         String value = replaceProperties(reader.getAttributeValue(i));
         Attribute attribute = Attribute.forName(reader.getAttributeLocalName(i));
         this.parseCacheAttribute(reader, i, attribute, value, builder, holder);
      }
   ...
   private void parseCacheAttribute(XMLExtendedStreamReader reader,
         int index, Attribute attribute, String value, ConfigurationBuilder builder, ConfigurationBuilderHolder holder) throws XMLStreamException {
      switch (attribute) {
         case NAME:
         case START:
         case JNDI_NAME:
   ...
   private void parseInvalidationCache(XMLExtendedStreamReader reader, ConfigurationBuilderHolder holder) throws XMLStreamException {
      ...
      for (int i = 0; i < reader.getAttributeCount(); i++) {
         String value = replaceProperties(reader.getAttributeValue(i));
         Attribute attribute = Attribute.forName(reader.getAttributeLocalName(i));
         this.parseClusteredCacheAttribute(reader, i, attribute, value, builder, baseCacheMode, holder);
      }
   ...
   private void parseClusteredCacheAttribute(XMLExtendedStreamReader reader,
         int index, Attribute attribute, String value, ConfigurationBuilder builder, CacheMode baseCacheMode, ConfigurationBuilderHolder holder)
         throws XMLStreamException {
      switch (attribute) {
         ...
         default: {
            this.parseCacheAttribute(reader, index, attribute, value, builder, holder);
         }
      }
   }
   ...
   private static class NullThreadFactory implements ThreadFactory {
      private static final ThreadFactory INSTANCE = new NullThreadFactory();
