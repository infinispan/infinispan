...
public enum Attribute {
   ...
   //Pedro -- total order stuff: the attribute is to change the commit protocol between
   // 2PC (original ISPN commit) and Total Order Protocol based
   TRANSACTION_PROTOCOL("transactionProtocol"),
   //Pedro -- total order stuff: thread pool configuration
