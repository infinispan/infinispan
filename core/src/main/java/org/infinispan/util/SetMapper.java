 ...
 * @author wburns
 * @since 9.0
 * @deprecated since 16.1, please use {@link org.infinispan.commons.util.SetMapper} instead
 */
@Deprecated
public class SetMapper<E, R> extends CollectionMapper<E, R> implements Set<R> {
   public SetMapper(Set<E> realCollection, Function<? super E, ? extends R> mapper) {
      ...
      if (!(mapper instanceof InjectiveFunction)) {
         throw new IllegalArgumentException("Function must also provided distinct values as evidenced by implementing" +
