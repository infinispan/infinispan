...
public class AnnotatedMethodCache {
   ...
   private static final DotName START_ANNOTATION = DotName.createSimple(Start.class.getName());
   private static final DotName STOP_ANNOTATION = DotName.createSimple(Stop.class.getName());
   ...
   static {
      try {
         ...
         // Scan for factories
         for (AnnotationInstance ai : annotationIndex.getAnnotations(DotName.createSimple(DefaultFactoryFor.class.getName()))) {
