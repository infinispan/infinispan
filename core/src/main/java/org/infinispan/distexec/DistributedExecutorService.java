...
public interface DistributedExecutorService extends ExecutorService {
   ...
   /**
    * Returns DistributedTaskBuilder for this DistributedExecutorService. As it name implies clients can use  
    * DistributedTaskBuilder to create DistributedTask instances.
    * 
    * @param <T>
    * @return service's DistributedTaskBuilder
    */
   <T> DistributedTaskBuilder<T> getDistributedTaskBuilder();
