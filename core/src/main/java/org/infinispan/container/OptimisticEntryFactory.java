 ...
 * @since 5.1
 */
public class OptimisticEntryFactory extends EntryFactoryImpl {

   private static Log log = LogFactory.getLog(OptimisticEntryFactory.class);
   ...
   public MVCCEntry wrapEntryForPut(InvocationContext ctx, Object key, boolean undeleteIfNeeded) throws InterruptedException {
      CacheEntry cacheEntry = getFromContext(ctx, key);
      MVCCEntry mvccEntry;
