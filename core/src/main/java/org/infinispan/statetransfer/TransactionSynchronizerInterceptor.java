 ...
 * interceptor chain, post {@link StateTransferInterceptor}, would only allow a single thread to amend a transaction.
 * <p>
 ...
 * </ul>
  * This interceptor must be placed after the logic that handles command forwarding ({@link StateTransferInterceptor}),
