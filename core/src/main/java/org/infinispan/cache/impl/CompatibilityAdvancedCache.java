...
/**
 * Advanced cache that converts values based on operation type before passing to the underlying
 * cache and subsequently converts the values to the original type for responses.
 *
 * @author wburns
 * @since 9.0
 */
public class CompatibilityAdvancedCache<K, V> extends TypeConverterDelegatingAdvancedCache<K, V> {
    ...
    public CompatibilityAdvancedCache(AdvancedCache<K, V> cache, Marshaller marshaller,
    ...
    private static TypeConverter setConverterMarshaller(TypeConverter converter,
