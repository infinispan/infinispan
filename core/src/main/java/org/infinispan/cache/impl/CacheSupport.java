...
public abstract class CacheSupport<K, V> implements BasicCache<K, V> {
     ...
     * manipulation. Don't remove or alter the signature even if it might look like unreachable
     * code. Implementors should perform a put operation but optimizing it as return values are not
     * required.
     *
     * @since 5.0
     */
