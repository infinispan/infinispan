...
public class ReplaceCommand extends AbstractDataWriteCommand implements MetadataAwareCommand {
   ...
   public Object perform(InvocationContext ctx) throws Throwable {
      ...
      if (hasAnyFlag(FlagBitSets.DISABLE_CONDITION) || (oldValue == null && prevValue != null) || (oldValue != null && oldValue.equals(prevValue))) {
         e.setChanged(true);
         e.setValue(newValue);
         ...
         successful = false;
         return hasAnyFlag(FlagBitSets.PROVIDED_RESULT) ? providedResult : (oldValue != null ? Boolean.FALSE : prevValue);
      }
   }
   ...
   public void writeTo(ObjectOutput output) throws IOException {
      ...
      if (!hasAnyFlag(FlagBitSets.DISABLE_CONDITION)) {
