...
public interface ReplicableCommand {
     ...
     *
     * <p>This method is optional. Unless your command never blocks, please implement {@link #invokeAsync()}
     * instead.</p>
     *
     * @since 9.0
     */
     ...
     * performed as well as return types. <b>Important</b>: this method will be invoked at the end of interceptors
     * chain. It should never be called directly from a custom interceptor.
     *
