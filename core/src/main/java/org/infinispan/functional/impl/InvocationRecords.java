...
public class InvocationRecords implements MetaParam<InvocationRecords> {
   ...
   public InvocationRecords(InvocationRecord records) {
   ...
   public static InvocationRecords join(CommandInvocationId id, Object returnValue, boolean authoritative, boolean created, boolean modified, boolean removed, long timestamp, InvocationRecords records) {
      return new InvocationRecords(new InvocationRecord(id, returnValue, authoritative, created, modified, removed, timestamp, records == null ? null : records.records));
   }
