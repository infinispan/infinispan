...
import org.infinispan.commons.dataconversion.UnknownTranscoder;
...
public class EncoderRegistryFactory extends AbstractComponentFactory implements AutoInstantiableFactory {
   ...
   public Object construct(String componentName) {
      ...
      // Deprecated unknown transcoder. Will be removed in a future version together with MediaType.APPLICATION_UNKNOWN.
      encoderRegistry.registerTranscoder(UnknownTranscoder.INSTANCE);
