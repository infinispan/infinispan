...
public class KnownComponentNames {
   ...
   public static final Collection<String> ALL_KNOWN_COMPONENT_NAMES = Arrays.asList(
      ASYNC_TRANSPORT_EXECUTOR, ASYNC_NOTIFICATION_EXECUTOR, PERSISTENCE_EXECUTOR, ASYNC_OPERATIONS_EXECUTOR, EXPIRATION_SCHEDULED_EXECUTOR, ASYNC_REPLICATION_QUEUE_EXECUTOR,
   ...
   static {
      ...
      DEFAULT_THREADCOUNTS.put(ASYNC_OPERATIONS_EXECUTOR, 25);
      ...
      DEFAULT_THREADPRIO.put(EXPIRATION_SCHEDULED_EXECUTOR, Thread.MIN_PRIORITY);
      ...
      DEFAULT_THREADPRIO.put(STATE_TRANSFER_EXECUTOR, Thread.NORM_PRIORITY);
      DEFAULT_THREADPRIO.put(ASYNC_OPERATIONS_EXECUTOR, Thread.NORM_PRIORITY);
   }
