 ...
 * the marshalling of said object is delegated to a user marshaller if configured ({@link
 * org.infinispan.configuration.global.SerializationConfiguration#MARSHALLER}) and the generated bytes are wrapped in a
 * {@link MarshallableUserObject} object and marshalled by ProtoStream.
 *
 * @author Ryan Emerson
 * @since 10.0
 */
...
public class PersistenceMarshallerImpl implements PersistenceMarshaller {
   ...
   public void start() {
      ...
      RawProtobufMarshaller<MarshallableUserObject> baseMarshaller = (RawProtobufMarshaller<MarshallableUserObject>) ctxRegistry.getPersistenceCtx().getMarshaller(MarshallableUserObject.class);
      ctxRegistry.addMarshaller(MarshallerType.PERSISTENCE, MarshallableUserObject.makeMarshaller(baseMarshaller, getUserMarshaller()));
   }
   ...
   private boolean requiresWrapping(Object o) {
      return userMarshaller != null && !isMarshallableWithProtoStream(o);
   }
