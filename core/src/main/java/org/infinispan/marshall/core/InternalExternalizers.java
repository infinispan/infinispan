...
import org.infinispan.functional.impl.InvocationRecords;
import org.infinispan.functional.impl.MetaParamsExternalizer;
...
final class InternalExternalizers {
   ...
   static ClassToExternalizerMap load(
      ...
      addInternalExternalizer(new InvocationRecords.Externalizer(), exts);
      ...
      addInternalExternalizer(new LocalModeAddress.Externalizer(), exts);
      ...
      addInternalExternalizer(new MetaParamsExternalizer(), exts);
