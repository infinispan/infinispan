...
final class ExternallyMarshallable {
   ...
   private static boolean isWhiteList(String className) {
      return className.endsWith("Exception")
            ...
            || className.equals("org.infinispan.marshall.core.StoreAsBinaryTest$Pojo")
            || className.equals("org.infinispan.marshall.core.StoreAsBinaryTest$CustomReadObjectMethod")
            || className.equals("org.infinispan.marshall.core.StoreAsBinaryTest$ObjectThatContainsACustomReadObjectMethod")
