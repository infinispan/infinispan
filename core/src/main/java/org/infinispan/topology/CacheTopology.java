...
public class CacheTopology {
   ...
   /**
    * Phase of topology change during rebalance. Using four phases guarantees these properties:
    *
    ...
    *
    * Old entries should be wiped out only after coming to the {@link #STABLE} phase.
    */
   public enum Phase {
      /**
      ...
      STABLE,
      /**
       * Used during rebalance: readCH == currentCH, writeCH = unionCH
       */
      READ_OLD_WRITE_ALL,
      /**
       * Used after rebalance completes: readCH == writeCH = unionCH
       */
      READ_ALL_WRITE_ALL,
      /**
