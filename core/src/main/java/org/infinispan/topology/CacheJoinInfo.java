...
/**
 * This class contains the information that a cache needs to supply to the coordinator when starting
 * up.
 *
 * @author Dan Berindei
 * @since 5.2
...
public class CacheJoinInfo {
    ...
    public CacheJoinInfo(ConsistentHashFactory consistentHashFactory, Hash hashFunction,
        int numSegments,
    ...
    public static class Externalizer extends AbstractExternalizer<CacheJoinInfo> {
        ...
        public void writeObject(ObjectOutput output,
            CacheJoinInfo cacheJoinInfo) throws IOException {
        ...
        @Override
        public CacheJoinInfo readObject(
            ObjectInput unmarshaller) throws IOException, ClassNotFoundException {
