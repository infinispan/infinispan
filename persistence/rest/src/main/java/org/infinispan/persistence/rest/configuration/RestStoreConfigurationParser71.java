...
public class RestStoreConfigurationParser71 implements ConfigurationParser {

   private static final Log log = LogFactory.getLog(RestStoreConfigurationParser71.class, Log.class);

   public RestStoreConfigurationParser71() {
   }
