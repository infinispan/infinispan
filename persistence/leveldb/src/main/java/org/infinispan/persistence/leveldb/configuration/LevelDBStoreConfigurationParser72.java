...
public class LevelDBStoreConfigurationParser72 implements ConfigurationParser {

   private static final Log log = LogFactory.getLog(LevelDBStoreConfigurationParser72.class);

   public LevelDBStoreConfigurationParser72() {
   }
