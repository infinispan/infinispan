...
public class ManagedConnectionFactoryConfiguration implements ConnectionFactoryConfiguration {
   ...
   public static final AttributeDefinition<DataSource> DATA_SOURCE = AttributeDefinition.builder("dataSource", null, DataSource.class).copier(identityCopier()).immutable().build();
