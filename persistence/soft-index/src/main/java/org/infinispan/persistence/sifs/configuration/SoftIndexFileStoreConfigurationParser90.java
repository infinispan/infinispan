...
@Namespaces({
      @Namespace(uri = "urn:infinispan:config:store:soft-index:9.0",
                 root = SoftIndexFileStoreConfigurationParser90.ROOT_ELEMENT),
      @Namespace(root = SoftIndexFileStoreConfigurationParser90.ROOT_ELEMENT)
})
public class SoftIndexFileStoreConfigurationParser90 implements ConfigurationParser {
   ...
   public SoftIndexFileStoreConfigurationParser90() {
   }
