...
public class RemoteStoreConfigurationParser72 implements ConfigurationParser {

   private static final Log log = LogFactory.getLog(RemoteStoreConfigurationParser72.class, Log.class);

   public RemoteStoreConfigurationParser72() {
   }
   ...
   private void parseAsyncTransportExecutor(final XMLExtendedStreamReader reader,
      ...
      builder.withExecutorProperties(Parser72.parseProperties(reader));
   }
