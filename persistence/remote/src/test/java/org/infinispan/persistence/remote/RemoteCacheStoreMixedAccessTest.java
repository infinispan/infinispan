...
import org.infinispan.persistence.remote.configuration.RemoteCacheStoreConfigurationBuilder;
...
@Test(testName = "persistence.remote.RemoteCacheStoreMixedAccessTest", groups="functional")
